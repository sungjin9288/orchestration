...
- 검증 필요: optional real-live OpenAI smoke in a visible configured environment, hosted/shareable demo access. Combined operator checklist: `docs/portfolio-open-items-handoff.md`.
