...
- It checks Dogfood Run 002, Dogfood Run 004, and Dogfood Run 005 linked worktree paths, branch names, dirty marker files, runtime roots, and current source repo status.
