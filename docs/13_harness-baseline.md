...
- `node scripts/harness-run.mjs doctor` reports a host-level summary of `ready / install-required / deferred / policy-blocked`
  ...
  plus a compact `summary` object, including `currentHostState`, `primaryHarnessId`, `primaryHarnessState`, and `primaryRecommendedAction`,
...
- runs harness inventory status plus smoke slices `01` through `04`, `06`, `07`, `08`, `09`, `10`, `11`, `12`, `13`, `14`, `15`, `16`, `17`, `18`, and `19`
