...
| --- | --- | --- | --- | --- |
| Required aggregate synthetic gate | pass | `node scripts/verification_status.mjs` | `ok=true`; required `1/1`; informational `105/105` | Keep as the default required docs/runtime aggregate gate. |
...
- growth engine routing now keeps the next default vNext workstream on
  `growth-evidence-ledger-proposal-record-dry-run-review-acceptance-finalization` after Growth Evidence Ledger proposal record dry-run review acceptance is
