...
| Product first-run polish | open | `docs/21_completion-development-roadmap.md`, `tasks/todo.md` | Next slice is `completion-first-run-product-polish-post-m7-1175` | Proceed after this inventory is committed. |
