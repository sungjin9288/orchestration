...
- inspect the Dogfood Run 067 retained-evidence update and kickoff evidence triage; only open a new implementation slice for a concrete regression or usability issue
...
- commit Dogfood Run 067 retained-evidence locally only after verification and explicit commit approval
- publish the Run 067 retained-evidence commit to `origin/main` only after commit approval and explicit push approval are both given
- clean up the Dogfood Run 067 retained linked worktree and branch only after retained-evidence is committed/published or explicitly deferred and destructive cleanup approval is given
