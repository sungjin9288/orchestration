...
- inspect the Dogfood Run 072 retained-evidence update, evidence inventory, and kickoff evidence triage; only open a new implementation slice for a concrete regression or usability issue
...
- commit Dogfood Run 072 retained-evidence docs locally only after verification and explicit commit approval
- publish Dogfood Run 072 retained-evidence only after explicit `git push origin main` approval
- clean up the Dogfood Run 072 retained linked worktree and branch only after retained-evidence is preserved and explicit destructive cleanup approval is given
- do not run another intentional `--execute --slug <slug>` dogfood pass until Run 072 retained-evidence is committed and the cleanup decision is settled
