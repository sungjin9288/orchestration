...
- commit Dogfood Run 050 cleanup-completed evidence locally after verification
- publish the Dogfood Run 050 evidence commits only after cleanup-completed evidence is committed locally and explicit push approval is given
- do not run another intentional `--execute --slug <slug>` dogfood pass until Dogfood Run 050 cleanup-completed evidence is clean/published
