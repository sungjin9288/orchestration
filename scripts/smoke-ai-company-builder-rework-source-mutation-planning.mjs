...
assert.match(inventory, /informational `302\/302`, total `303\/303`/);
...
assert.equal(countFiles(/^smoke-.*\.mjs$/), 997);
assert.equal(countFiles(/^smoke-ui-slice-.*\.mjs$/), 711);
