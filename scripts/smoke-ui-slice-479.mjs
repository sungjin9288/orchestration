...
console.log(
  JSON.stringify(
    {
      ok: true,
      harnessExecutionHiddenPreviewButtonBorderBalance: {
        insertionPoint: 'hiddenExecutionResultRegister->hiddenActionShelfDesign->previewButtonBorder',
        marker: 'hidden result preview button uses stronger border balance',
      },
    },
    null,
    2,
