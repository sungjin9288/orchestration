...
console.log(
  JSON.stringify(
    {
      ok: true,
      harnessExecutionHiddenResultPreviewInkFollowup: {
        insertionPoint: 'hiddenExecutionResultRegister->hiddenPreviewExcerpt->inkReadability',
        marker: 'hidden result preview excerpt uses stable evidence ink',
      },
    },
    null,
    2,
