...
const proposalApplicationImplementationPlanSources = readRepoFiles(
  repoRoot,
  proposalApplicationImplementationPlanFiles,
);

assertMarkdownSections(
  proposalApplicationImplementationPlanSources.plan,
  proposalApplicationImplementationPlanSections,
);
...
const proposalApplicationImplementationPlanSourceEvidence = {
  ...
  growthConfig: proposalApplicationImplementationPlanBlockedAuthorityMarkers,
