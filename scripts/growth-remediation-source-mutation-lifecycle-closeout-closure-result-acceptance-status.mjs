...
const CLOSURE_RESULT_ACCEPTANCE_STATES = [
  'source-mutation-lifecycle-closeout-closure-result-acceptance-not-started',
  'source-mutation-lifecycle-closeout-closure-result-acceptance-ready',
  'source-mutation-lifecycle-closeout-closure-result-acceptance-blocked',
  ...
  'source-mutation-lifecycle-closeout-closure-result-acceptance-deferred',
  ...
  'stale-source-mutation-lifecycle-closeout-closure-result-acceptance-blocked',
  'closed-no-action',
];

const CLOSURE_RESULT_ACCEPTANCE_DECISION_TYPES = [
  ...
  'reject-source-mutation-lifecycle-closeout-closure-result-acceptance',
  'defer-source-mutation-lifecycle-closeout-closure-result-acceptance',
  'hold-baseline',
];

const CLOSURE_RESULT_ACCEPTANCE_EVIDENCE_TYPES = [
...
const CLOSURE_RESULT_ACCEPTANCE_BLOCKER_TYPES = [
...
function summarizeSources(sources) {
  ...
  return {
    ...
    harnessMentionsSourceMutationLifecycleCloseoutClosureResultAcceptance:
    ...
    ledgerMentionsSourceMutationLifecycleCloseoutClosureResultAcceptance:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-result-acceptance-status-readonly-post-m7-858/.test(
        todo,
      ),
    verificationIncludesSourceMutationLifecycleCloseoutClosureResultAcceptance:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-result-acceptance-status/.test(
        verificationStatus,
      ),
    ...
    sourceMutationLifecycleCloseoutClosureResultAcceptanceSeparateFromMutation:
      /source mutation lifecycle closeout closure result acceptance status stays separate from actual source mutation execution/.test(
        plan,
      ),
    sourceMutationLifecycleCloseoutClosureResultAcceptanceStillBlocked:
...
const sourceMutationLifecycleCloseoutClosureResultAcceptanceSchema = {
  sourceMutationLifecycleCloseoutClosureResultAcceptanceRecord: fields(
    [
  ...
  sourceMutationLifecycleCloseoutClosureResultAcceptanceDecision: fields(
    [
      'decisionId',
      'sourceMutationLifecycleCloseoutClosureResultAcceptanceId',
      'sourceMutationLifecycleCloseoutClosureResultReviewAcceptanceId',
  ...
  sourceMutationLifecycleCloseoutClosureResultAcceptanceBlocker: fields(
    [
      'blockerId',
      'sourceMutationLifecycleCloseoutClosureResultAcceptanceId',
      'sourceMutationLifecycleCloseoutClosureResultReviewAcceptanceId',
  ...
  sourceMutationLifecycleCloseoutClosureResultAcceptanceIndex: fields(
    [
      'indexId',
...
const sourceMutationLifecycleCloseoutClosureResultAcceptanceRules = [
  {
    id: 'source-mutation-lifecycle-closeout-closure-result-acceptance-requires-current-review-acceptance-chain',
    rule:
      'source mutation lifecycle closeout closure result acceptance can only bind to one current lifecycle closeout closure result review acceptance record and its current lifecycle closeout chain',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-result-acceptance-is-not-lifecycle-closure-or-source-mutation',
    rule:
      'source mutation lifecycle closeout closure result acceptance status may mark closure readiness, but it cannot close the lifecycle, mutate accepted records, apply patches, mutate source, execute remediation, commit, push, or release',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-result-acceptance-requires-criteria-decision-and-reviewer-notes',
    rule:
      'lifecycle closeout closure result acceptance criteria refs, result acceptance decision note refs, result review acceptance criteria refs, result review acceptance decision note refs, and result reviewer note refs must be present before closure status can be considered',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-result-acceptance-requires-verification-dry-run-and-rollback-proof',
    rule:
      'clean baseline proof, exact scope lock, target lock, baseline digest, patch draft refs, diff preview refs, verification output refs, dry-run proof refs, rollback proof refs, source-of-truth refs, task ledger refs, and negative evidence clearance must be present before source mutation lifecycle closeout closure can be considered',
  },
  {
    id: 'failed-stale-broad-dirty-or-mutating-lifecycle-closeout-closure-result-acceptance-blocks-closure',
    rule:
      'stale result acceptance proof, stale review acceptance proof, stale result review proof, stale result proof, stale execution proof, dirty or untracked baseline, changed patch or diff proof, failed verification, missing rollback proof, missing closure result acceptance criteria, missing closure result acceptance decision note, missing reviewer note, unresolved negative evidence, unapproved file touches, or any attempted source mutation or lifecycle closure blocks lifecycle closeout closure',
  },
];
...
const requiredFieldsSatisfied = Object.values(
  sourceMutationLifecycleCloseoutClosureResultAcceptanceSchema,
...
const payload = {
  ...
  sourceSummary,
  vocabulary: {
    sourceMutationLifecycleCloseoutClosureResultAcceptanceStates:
      CLOSURE_RESULT_ACCEPTANCE_STATES,
    sourceMutationLifecycleCloseoutClosureResultAcceptanceDecisionTypes:
      CLOSURE_RESULT_ACCEPTANCE_DECISION_TYPES,
    sourceMutationLifecycleCloseoutClosureResultAcceptanceEvidenceTypes:
      CLOSURE_RESULT_ACCEPTANCE_EVIDENCE_TYPES,
    sourceMutationLifecycleCloseoutClosureResultAcceptanceBlockerTypes:
      CLOSURE_RESULT_ACCEPTANCE_BLOCKER_TYPES,
  },
  sourceMutationLifecycleCloseoutClosureResultAcceptanceSchema,
  sourceMutationLifecycleCloseoutClosureResultAcceptanceRules,
  sourceMutationLifecycleCloseoutClosureResultAcceptanceState: {
    realSourceMutationLifecycleCloseoutClosureResultAcceptanceFileAdopted: false,
    discoveredSourceMutationLifecycleCloseoutClosureResultAcceptanceRecords: 0,
  ...
  readiness: {
    requiredFieldsSatisfied,
    sourceMutationLifecycleCloseoutClosureResultAcceptanceRecordTypes: Object.keys(
      sourceMutationLifecycleCloseoutClosureResultAcceptanceSchema,
    ).length,
    ...
    sourceMutationLifecycleCloseoutClosureResultAcceptanceAndMutationSeparate: true,
    closureAllowed: false,
    resultAccepted: false,
    lifecycleClosed: false,
    sourceMutationAllowed: false,
    ...
    readyForSourceMutationLifecycleCloseoutClosureStatus: true,
  },
  nextRecommendedSlice: {
    ...
    reason:
      'Source mutation lifecycle closeout closure result acceptance is now modeled as read-only; the next safe slice should check lifecycle closeout closure status without closing the lifecycle, patch application, or source mutation.',
