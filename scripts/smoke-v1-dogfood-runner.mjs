...
assert.match(dogfood, /Dogfood Run 066 worktree retained: `\/Users\/sungjin\/dev\/personal\/orchestration--v1-dogfood-runner-063`/);
assert.match(dogfood, /branch retained: `worktree\/v1-dogfood-runner-063`/);
