...
assert.match(dogfood, /Dogfood Run 037 retained linked worktree cleanup remains pending until retained-evidence docs are committed and destructive cleanup runs/);
assert.match(dogfood, /Dogfood Run 037 worktree retained/);
