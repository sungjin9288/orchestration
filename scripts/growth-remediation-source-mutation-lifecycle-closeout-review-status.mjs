...
requireNoCliArgs(process.argv.slice(2), {
  mode: 'growth-remediation-source-mutation-lifecycle-closeout-review-status',
});
...
const SOURCE_MUTATION_LIFECYCLE_CLOSEOUT_REVIEW_STATES = [
  'source-mutation-lifecycle-closeout-review-not-started',
  'source-mutation-lifecycle-closeout-review-ready',
  'source-mutation-lifecycle-closeout-review-blocked',
  'source-mutation-lifecycle-closeout-review-ready-for-acceptance-contract',
  'source-mutation-lifecycle-closeout-review-rejected',
  'source-mutation-lifecycle-closeout-review-deferred',
  ...
  'stale-source-mutation-lifecycle-closeout-review-blocked',
  'closed-no-action',
];

const SOURCE_MUTATION_LIFECYCLE_CLOSEOUT_REVIEW_DECISION_TYPES = [
  ...
  'request-source-mutation-lifecycle-closeout-reviewer-note',
  'request-source-mutation-lifecycle-closeout-review-decision-note',
  'request-negative-evidence-clearance',
  'reject-source-mutation-lifecycle-closeout-review',
  'defer-source-mutation-lifecycle-closeout-review',
  'hold-baseline',
];

const SOURCE_MUTATION_LIFECYCLE_CLOSEOUT_REVIEW_EVIDENCE_TYPES = [
...
const SOURCE_MUTATION_LIFECYCLE_CLOSEOUT_REVIEW_BLOCKER_TYPES = [
  ...
  'source-mutation-lifecycle-closeout-reviewer-note-missing',
  'source-mutation-lifecycle-closeout-review-decision-note-missing',
...
function summarizeSources(sources) {
  ...
  return {
    ...
    harnessMentionsSourceMutationLifecycleCloseoutReview:
      /growth-remediation-source-mutation-lifecycle-closeout-review-status/.test(harnessBaseline),
    completionReadinessMentionsSourceMutationLifecycleCloseoutReview:
      /growth-remediation-source-mutation-lifecycle-closeout-review-status/.test(
        completionReadiness,
      ),
    ledgerMentionsSourceMutationLifecycleCloseoutReview:
      /growth-remediation-source-mutation-lifecycle-closeout-review-status-readonly-post-m7-848/.test(
        todo,
      ),
    verificationIncludesSourceMutationLifecycleCloseoutReview:
      /growth-remediation-source-mutation-lifecycle-closeout-review-status/.test(
        verificationStatus,
      ),
    ...
    sourceMutationLifecycleCloseoutReviewerNoteRefsDocumented:
      /source mutation lifecycle closeout reviewer note refs/.test(plan),
    sourceMutationLifecycleCloseoutReviewDecisionNoteRefsDocumented:
      /source mutation lifecycle closeout review decision note refs/.test(plan),
    ...
    sourceMutationLifecycleCloseoutReviewSeparateFromMutation:
      /source mutation lifecycle closeout review status stays separate from actual source mutation execution/.test(
        plan,
      ),
    sourceMutationLifecycleCloseoutReviewStillBlocked:
      /before\s+source mutation lifecycle closeout review acceptance can be\s+considered/.test(
        plan,
      ),
...
const sourceMutationLifecycleCloseoutReviewSchema = {
  sourceMutationLifecycleCloseoutReviewRecord: fields(
    [
  ...
  sourceMutationLifecycleCloseoutReviewDecision: fields(
    [
      'decisionId',
      'sourceMutationLifecycleCloseoutReviewId',
      'sourceMutationLifecycleCloseoutId',
  ...
  sourceMutationLifecycleCloseoutReviewBlocker: fields(
    [
      'blockerId',
      'sourceMutationLifecycleCloseoutReviewId',
      'sourceMutationLifecycleCloseoutId',
  ...
  sourceMutationLifecycleCloseoutReviewIndex: fields(
    [
      'indexId',
...
const sourceMutationLifecycleCloseoutReviewRules = [
  {
    id: 'source-mutation-lifecycle-closeout-review-requires-current-closeout-chain',
    rule:
      'source mutation lifecycle closeout review can only bind to one current lifecycle closeout record and its accepted completion review chain',
  },
  {
    id: 'source-mutation-lifecycle-closeout-review-is-not-source-mutation',
    rule:
      'source mutation lifecycle closeout review status may mark acceptance readiness, but it cannot close the lifecycle, mutate accepted records, apply patches, mutate source, execute remediation, commit, push, or release',
  },
  {
    id: 'source-mutation-lifecycle-closeout-review-requires-reviewer-and-decision-notes',
    rule:
      'lifecycle closeout reviewer note refs and lifecycle closeout review decision note refs must be present before lifecycle closeout review acceptance can be considered',
  },
  {
    id: 'source-mutation-lifecycle-closeout-review-requires-verification-dry-run-and-rollback-proof',
    rule:
      'clean baseline proof, exact scope lock, target lock, baseline digest, patch draft refs, diff preview refs, verification output refs, dry-run proof refs, rollback proof refs, source-of-truth refs, task ledger refs, and negative evidence clearance must be present before source mutation lifecycle closeout review acceptance can be considered',
  },
  {
    id: 'failed-stale-broad-dirty-or-mutating-lifecycle-closeout-review-blocks-acceptance',
    rule:
      'stale review proof, stale closeout proof, stale review acceptance proof, dirty or untracked baseline, changed patch or diff proof, failed verification, missing rollback proof, missing reviewer note, missing review decision note, unresolved negative evidence, unapproved file touches, or any attempted source mutation blocks lifecycle closeout review acceptance readiness',
  },
];
...
const requiredFieldsSatisfied = Object.values(sourceMutationLifecycleCloseoutReviewSchema).every(
...
const ok =
  ...
  sourceSummary.harnessMentionsSourceMutationLifecycleCloseoutReview &&
  sourceSummary.completionReadinessMentionsSourceMutationLifecycleCloseoutReview &&
  sourceSummary.ledgerMentionsSourceMutationLifecycleCloseoutReview &&
  sourceSummary.verificationIncludesSourceMutationLifecycleCloseoutReview &&
  sourceSummary.sourceMutationLifecycleCloseoutReviewAcceptanceNextDocumented &&
  ...
  sourceSummary.sourceMutationLifecycleCloseoutReviewerNoteRefsDocumented &&
  sourceSummary.sourceMutationLifecycleCloseoutReviewDecisionNoteRefsDocumented &&
  ...
  sourceSummary.sourceMutationLifecycleCloseoutReviewSeparateFromMutation &&
  sourceSummary.sourceMutationLifecycleCloseoutReviewStillBlocked &&
...
const payload = {
  ok,
  mode: 'growth-remediation-source-mutation-lifecycle-closeout-review-status',
  posture: 'local-read-only-remediation-source-mutation-lifecycle-closeout-review-contract',
  currentHead: {
  ...
  schemaVersion: 'growth-remediation-source-mutation-lifecycle-closeout-review-status/v0',
  sourceSummary,
  vocabulary: {
    sourceMutationLifecycleCloseoutReviewStates:
      SOURCE_MUTATION_LIFECYCLE_CLOSEOUT_REVIEW_STATES,
    sourceMutationLifecycleCloseoutReviewDecisionTypes:
      SOURCE_MUTATION_LIFECYCLE_CLOSEOUT_REVIEW_DECISION_TYPES,
    sourceMutationLifecycleCloseoutReviewEvidenceTypes:
      SOURCE_MUTATION_LIFECYCLE_CLOSEOUT_REVIEW_EVIDENCE_TYPES,
    sourceMutationLifecycleCloseoutReviewBlockerTypes:
      SOURCE_MUTATION_LIFECYCLE_CLOSEOUT_REVIEW_BLOCKER_TYPES,
  },
  sourceMutationLifecycleCloseoutReviewSchema,
  sourceMutationLifecycleCloseoutReviewRules,
  sourceMutationLifecycleCloseoutReviewState: {
    realSourceMutationLifecycleCloseoutReviewFileAdopted: false,
    discoveredSourceMutationLifecycleCloseoutReviewRecords: 0,
    lifecycleClosed: false,
    sourceMutationAllowed: false,
    acceptedRecordMutationAllowed: false,
    rollbackExecutionAllowed: false,
    remediationExecutionAllowed: false,
    currentStatus: 'contract-only-no-active-source-mutation-lifecycle-closeout-review',
  },
  readiness: {
    requiredFieldsSatisfied,
    sourceMutationLifecycleCloseoutReviewRecordTypes: Object.keys(
      sourceMutationLifecycleCloseoutReviewSchema,
    ).length,
    ...
    sourceMutationLifecycleCloseoutReviewerNoteRequired: true,
    sourceMutationLifecycleCloseoutReviewDecisionNoteRequired: true,
    negativeEvidenceClearanceRequired: true,
    sourceMutationLifecycleCloseoutReviewAndMutationSeparate: true,
    lifecycleClosed: false,
    sourceMutationAllowed: false,
    acceptedRecordMutationAllowed: false,
    rollbackExecutionAllowed: false,
    ...
    readyForSourceMutationLifecycleCloseoutReviewAcceptanceStatus: true,
  },
  nextRecommendedSlice: {
    ...
    reason:
      'Source mutation lifecycle closeout review is now modeled as read-only; the next safe slice should accept review readiness before lifecycle closure, patch application, or source mutation.',
