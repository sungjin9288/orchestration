...
console.log(
  JSON.stringify(
    {
      ok: true,
      harnessExecutionHiddenOperatorContextCodeFontSizeFollowup: {
        insertionPoint: 'hiddenExecutionResultRegister->hiddenOperatorContextGroup->monoValueDensity',
        marker: 'hidden operator-context code uses compact density',
      },
    },
    null,
    2,
