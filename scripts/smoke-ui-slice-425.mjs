...
console.log(
  JSON.stringify(
    {
      ok: true,
      harnessExecutionHiddenResultShowReadTier: {
        insertionPoint: 'hiddenExecutionResultRegister->hiddenShowReadTier->showControl',
        marker: 'hidden result show button uses read-tier emphasis',
      },
    },
    null,
    2,
