...
assert.match(appJs, /formatHarnessPolicyReportForCopy\(getHarnessPolicyReportPayload\(hiddenHarnessExecutionResult\)\)/);
assert.match(appJs, /formatHarnessPolicyReportForCopy\(getHarnessPolicyReportPayload\(execution\)\)/);
