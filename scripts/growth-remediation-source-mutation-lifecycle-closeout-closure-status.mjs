...
const MODE = 'growth-remediation-source-mutation-lifecycle-closeout-closure-status';
...
const CLOSURE_STATES = [
  'source-mutation-lifecycle-closeout-closure-not-started',
  'source-mutation-lifecycle-closeout-closure-ready',
  'source-mutation-lifecycle-closeout-closure-blocked',
  'source-mutation-lifecycle-closeout-closure-ready-for-review-contract',
  'source-mutation-lifecycle-closeout-closure-rejected',
  'source-mutation-lifecycle-closeout-closure-deferred',
  ...
  'stale-source-mutation-lifecycle-closeout-closure-blocked',
  'closed-no-action',
];

const CLOSURE_DECISION_TYPES = [
  ...
  'reject-source-mutation-lifecycle-closeout-closure',
  'defer-source-mutation-lifecycle-closeout-closure',
  'hold-baseline',
];

const CLOSURE_EVIDENCE_TYPES = [
...
function summarizeSources(sources) {
  ...
  return {
    ...
    sourceMutationLifecycleCloseoutClosureResultAcceptanceDocumented:
    ...
    harnessMentionsSourceMutationLifecycleCloseoutClosure:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-status/.test(harnessBaseline),
    completionReadinessMentionsSourceMutationLifecycleCloseoutClosure:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-status/.test(
        completionReadiness,
      ),
    ledgerMentionsSourceMutationLifecycleCloseoutClosure:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-status-readonly-post-m7-859/.test(
        todo,
      ),
    verificationIncludesSourceMutationLifecycleCloseoutClosure:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-status/.test(
        verificationStatus,
      ),
    ...
    sourceMutationLifecycleCloseoutClosureSeparateFromMutation:
      /source mutation lifecycle closeout closure status stays separate from actual source mutation execution/.test(
        plan,
      ),
    sourceMutationLifecycleCloseoutClosureStillBlocked:
...
const sourceMutationLifecycleCloseoutClosureSchema = {
  sourceMutationLifecycleCloseoutClosureRecord: fields(
    [
  ...
  sourceMutationLifecycleCloseoutClosureDecision: fields(
    [
      'decisionId',
      'sourceMutationLifecycleCloseoutClosureId',
      'sourceMutationLifecycleCloseoutClosureResultAcceptanceId',
  ...
  sourceMutationLifecycleCloseoutClosureBlocker: fields(
    [
      'blockerId',
      'sourceMutationLifecycleCloseoutClosureId',
      'sourceMutationLifecycleCloseoutClosureResultAcceptanceId',
  ...
  sourceMutationLifecycleCloseoutClosureIndex: fields(
    [
      'indexId',
...
const sourceMutationLifecycleCloseoutClosureRules = [
  {
    id: 'source-mutation-lifecycle-closeout-closure-requires-current-result-acceptance-chain',
    rule:
      'source mutation lifecycle closeout closure status can only bind to one current lifecycle closeout closure result acceptance record and its current lifecycle closeout chain',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-is-not-final-lifecycle-close-or-source-mutation',
    rule:
      'source mutation lifecycle closeout closure status may mark review readiness, but it cannot close the lifecycle, mutate accepted records, apply patches, mutate source, execute remediation, commit, push, or release',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-requires-criteria-decision-and-reviewer-notes',
    rule:
      'lifecycle closeout closure criteria refs, closure decision note refs, closure result acceptance criteria refs, closure result acceptance decision note refs, and closure result reviewer note refs must be present before closure review status can be considered',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-requires-verification-dry-run-and-rollback-proof',
    rule:
      'clean baseline proof, exact scope lock, target lock, baseline digest, patch draft refs, diff preview refs, verification output refs, dry-run proof refs, rollback proof refs, source-of-truth refs, task ledger refs, and negative evidence clearance must be present before source mutation lifecycle closeout closure review can be considered',
  },
  {
    id: 'failed-stale-broad-dirty-or-mutating-lifecycle-closeout-closure-blocks-review',
    rule:
      'stale closure proof, stale result acceptance proof, stale review acceptance proof, stale result review proof, stale result proof, stale execution proof, dirty or untracked baseline, changed patch or diff proof, failed verification, missing rollback proof, missing closure criteria, missing closure decision note, missing result acceptance criteria, missing result acceptance decision note, missing reviewer note, unresolved negative evidence, unapproved file touches, or any attempted source mutation or lifecycle close blocks lifecycle closeout closure review',
  },
];
...
const requiredFieldsSatisfied = Object.values(sourceMutationLifecycleCloseoutClosureSchema).every(
...
const payload = {
  ok,
  mode: MODE,
  posture: 'local-read-only-remediation-source-mutation-lifecycle-closeout-closure-contract',
  currentHead: {
  ...
  schemaVersion: 'growth-remediation-source-mutation-lifecycle-closeout-closure-status/v0',
  sourceSummary,
  vocabulary: {
    sourceMutationLifecycleCloseoutClosureStates: CLOSURE_STATES,
    sourceMutationLifecycleCloseoutClosureDecisionTypes: CLOSURE_DECISION_TYPES,
    sourceMutationLifecycleCloseoutClosureEvidenceTypes: CLOSURE_EVIDENCE_TYPES,
    sourceMutationLifecycleCloseoutClosureBlockerTypes: CLOSURE_BLOCKER_TYPES,
  },
  sourceMutationLifecycleCloseoutClosureSchema,
  sourceMutationLifecycleCloseoutClosureRules,
  sourceMutationLifecycleCloseoutClosureState: {
    realSourceMutationLifecycleCloseoutClosureFileAdopted: false,
    discoveredSourceMutationLifecycleCloseoutClosureRecords: 0,
    closureReviewAllowed: false,
    lifecycleClosed: false,
    sourceMutationAllowed: false,
    acceptedRecordMutationAllowed: false,
    rollbackExecutionAllowed: false,
    remediationExecutionAllowed: false,
    currentStatus: 'contract-only-no-active-source-mutation-lifecycle-closeout-closure',
  },
  readiness: {
    requiredFieldsSatisfied,
    sourceMutationLifecycleCloseoutClosureRecordTypes: Object.keys(
      sourceMutationLifecycleCloseoutClosureSchema,
    ).length,
    ...
    sourceMutationLifecycleCloseoutClosureAndMutationSeparate: true,
    readyForSourceMutationLifecycleCloseoutClosureReviewStatus: true,
    closureReviewAllowed: false,
    lifecycleClosed: false,
    sourceMutationAllowed: false,
    acceptedRecordMutationAllowed: false,
  ...
  nextRecommendedSlice: {
    ...
    reason:
      'Source mutation lifecycle closeout closure status is now modeled as read-only; the next safe slice should define closure review status without final lifecycle closure, patch application, or source mutation.',
