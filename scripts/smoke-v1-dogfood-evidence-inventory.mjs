...
assert.match(dogfood, /Retained cleanup pending after explicit Dogfood Run 080 execute approval/);
assert.match(dogfood, /Dogfood Run 080 worktree retained: `\/Users\/sungjin\/dev\/personal\/orchestration--v1-dogfood-runner-077`/);
assert.match(dogfood, /Branch retained: `worktree\/v1-dogfood-runner-077`/);
assert.match(dogfood, /Runtime evidence remains available under `var\/runtime-v1-dogfood-runner-v1-dogfood-runner-077`/);
assert.match(dogfood, /Dogfood Run 080 worktree retained for evidence until retained-evidence commit\/publish and explicit destructive cleanup approval/);
