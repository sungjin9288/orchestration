...
assert.match(dogfood, /Retained cleanup pending after explicit Dogfood Run 045 execute approval/);
assert.doesNotMatch(dogfood, /No retained dogfood linked worktree remains after Dogfood Run 044 cleanup/);
