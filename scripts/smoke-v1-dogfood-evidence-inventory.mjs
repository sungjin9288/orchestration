...
assert.match(dogfood, /Dogfood Run 066 cleanup-completed evidence is being recorded on source `main` before commit\/push/);
...
assert.doesNotMatch(dogfood, /Expected dirty marker remains `prompts\/builder\.md`/);
