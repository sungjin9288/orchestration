...
console.log(
  JSON.stringify(
    {
      ok: true,
      harnessExecutionHiddenHarnessContextLineHeightFollowup: {
        insertionPoint: 'hiddenExecutionResultRegister->hiddenHarnessContextGroup->copyRhythm',
        marker: 'hidden harness-context copy uses tighter summary rhythm',
      },
    },
    null,
    2,
