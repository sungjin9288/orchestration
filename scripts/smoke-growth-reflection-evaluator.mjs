...
assert.match(
  plan,
  /Build `growth-evidence-ledger-proposal-record-dry-run-review-acceptance-finalization-review[a-z-]+finalization-review-acceptance` as the next\s+read-only vNext status\/doc-smoke slice/,
);
assert.match(
  plan,
