...
assert.match(
  ...
  /^growth-evidence-ledger-proposal-record-dry-run-review-acceptance-finalization-review[a-z-]+review-needed$/,
);
assert.equal(
...
assert.match(
  plan,
  /Build `growth-evidence-ledger-proposal-record-dry-run-review-acceptance-finalization-review[a-z-]+review` as the next\s+read-only vNext status\/doc-smoke slice/,
);
assert.match(
  plan,
