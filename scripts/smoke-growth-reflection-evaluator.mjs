...
assert.equal(
  payload.evaluationInput.sourceSummary.growthEvidenceLedgerProposalReadinessStatusScriptPresent,
  true,
);
assert.equal(
  payload.evaluationInput.sourceSummary.growthEvidenceLedgerProposalReadinessStatusDocumented,
  true,
);
assert.equal(
  payload.evaluationInput.sourceSummary.growthEvidenceLedgerProposalReadinessStatusAggregateRegistered,
  true,
);
assert.equal(
  payload.evaluationInput.sourceSummary.growthEvidenceLedgerProposalQueueHandoffStatusScriptPresent,
  true,
);
assert.equal(
  payload.evaluationInput.sourceSummary.growthEvidenceLedgerProposalQueueHandoffStatusDocumented,
  true,
);
assert.equal(
  payload.evaluationInput.sourceSummary.growthEvidenceLedgerProposalQueueHandoffStatusAggregateRegistered,
  true,
);
assert.equal(
  payload.evaluationInput.sourceSummary.growthEvidenceLedgerProposalRecordReadinessStatusScriptPresent,
  true,
);
assert.equal(
  payload.evaluationInput.sourceSummary.growthEvidenceLedgerProposalRecordReadinessStatusDocumented,
  true,
);
assert.equal(
...
assert.equal(
  payload.evaluationInput.sourceSummary.growthEvidenceLedgerProposalRecordDryRunShapeStatusScriptPresent,
  true,
);
assert.equal(
  payload.evaluationInput.sourceSummary.growthEvidenceLedgerProposalRecordDryRunShapeStatusDocumented,
  true,
);
assert.equal(
  payload.evaluationInput.sourceSummary.growthEvidenceLedgerProposalRecordDryRunShapeStatusAggregateRegistered,
  true,
);
assert.equal(
  payload.evaluationInput.sourceSummary
...
assert.equal(
  payload.evaluationInput.sourceSummary.growthEvidenceLedgerProposalRecordDryRunReviewStatusScriptPresent,
  true,
);
assert.equal(
  payload.evaluationInput.sourceSummary.growthEvidenceLedgerProposalRecordDryRunReviewStatusDocumented,
  true,
);
assert.equal(
  payload.evaluationInput.sourceSummary.growthEvidenceLedgerProposalRecordDryRunReviewStatusAggregateRegistered,
  true,
);
...
assert.equal(proposalRecordCreationReadinessPayload.readiness.creationReadinessEnvelopeDefined, true);
assert.equal(proposalRecordCreationReadinessPayload.readiness.allCreationPolicyFieldsCovered, true);
...
assert.equal(proposalRecordDryRunReviewAcceptancePayload.readiness.proposalRecordCreationAllowed, false);
...
assert.match(
  plan,
  /Build `growth-evidence-ledger-proposal-record-dry-run-review-acceptance-finalization-review-acceptance-finalization-review-acceptance-finalization-review-acceptance-finalization-review-acceptance-finalization-review` as the next\s+read-only vNext status\/doc-smoke slice/,
);
assert.match(
  plan,
