...
assert.equal(payload.summary.primaryInstallReviewRequired, primaryHarness?.installReview != null);
assert.equal(payload.summary.primaryInstallReviewRequired, true);
  ...
  JSON.stringify(
    {
      ok: true,
      runScript,
      primaryInstallReviewRequired: payload.summary.primaryInstallReviewRequired,
    },
    null,
    2,
  ),
