...
async function main() {
  ...
  try {
    ...
    writeState(futureRoot, { ...currentState, schemaVersion: 22 });
    ...
    const extraFieldState = JSON.parse(fs.readFileSync(statePath, 'utf8'));
    ...
    assert.equal(reloaded.getSnapshot().schemaVersion, 21);
