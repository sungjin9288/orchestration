...
requireNoCliArgs(process.argv.slice(2), {
  mode: 'growth-remediation-source-mutation-completion-review-status',
});
...
const SOURCE_MUTATION_COMPLETION_REVIEW_STATES = [
  'source-mutation-completion-review-not-started',
  'source-mutation-completion-review-ready',
  'source-mutation-completion-review-blocked',
  'source-mutation-completion-review-ready-for-acceptance-contract',
  'source-mutation-completion-review-rejected',
  'source-mutation-completion-review-deferred',
  ...
  'stale-source-mutation-completion-review-blocked',
  'closed-no-action',
];

const SOURCE_MUTATION_COMPLETION_REVIEW_DECISION_TYPES = [
  'approve-source-mutation-completion-review-acceptance-readiness',
  ...
  'reject-source-mutation-completion-review',
  'defer-source-mutation-completion-review',
  'hold-baseline',
];

const SOURCE_MUTATION_COMPLETION_REVIEW_EVIDENCE_TYPES = [
...
const SOURCE_MUTATION_COMPLETION_REVIEW_BLOCKER_TYPES = [
  ...
  'source-mutation-completion-reviewer-note-missing',
  'source-mutation-completion-review-decision-note-missing',
  'negative-evidence-unresolved',
  'unapproved-file-touch',
  'source-mutation-completion-review-status-attempts-source-mutation',
];
...
function summarizeSources(sources) {
  ...
  const sourceMutationCompletionReview = sourceText(
    sources,
    'scripts/growth-remediation-source-mutation-completion-review-status.mjs',
  );
  ...
  return {
    ...
    sourceMutationCompletionReviewImplemented:
      /mode: 'growth-remediation-source-mutation-completion-review-status'/.test(
        sourceMutationCompletionReview,
      ),
    ...
    harnessMentionsSourceMutationCompletionReview:
      /growth-remediation-source-mutation-completion-review-status/.test(harnessBaseline),
    completionReadinessMentionsSourceMutationCompletionReview:
      /growth-remediation-source-mutation-completion-review-status/.test(completionReadiness),
    ledgerMentionsSourceMutationCompletionReview:
      /growth-remediation-source-mutation-completion-review-status-readonly-post-m7-845/.test(
        todo,
      ),
    verificationIncludesSourceMutationCompletionReview:
      /growth-remediation-source-mutation-completion-review-status/.test(verificationStatus),
    ...
    sourceMutationCompletionReviewSeparateFromMutation:
      /source mutation completion review status stays separate from actual source mutation execution/.test(
        plan,
      ),
    sourceMutationCompletionReviewAcceptanceStillBlocked:
      /before\s+source mutation completion review acceptance can be\s+considered/.test(plan),
...
const sourceMutationCompletionReviewSchema = {
  sourceMutationCompletionReviewRecord: fields(
    [
      ...
      'taskLedgerRefs',
      'blockerRefs',
      'sourceMutationCompletionReviewAcceptanceAllowed',
      'sourceMutationAllowed',
      'remediationExecutionAllowed',
    ],
    ['ownerSurface', 'operatorNotes'],
  ),
  sourceMutationCompletionReviewDecision: fields(
    [
      'decisionId',
      'sourceMutationCompletionReviewId',
      'sourceMutationCompletionId',
  ...
  sourceMutationCompletionReviewBlocker: fields(
    [
      'blockerId',
      'sourceMutationCompletionReviewId',
      'sourceMutationCompletionId',
      ...
      'severity',
      'evidenceRefs',
      'blocksSourceMutationCompletionReviewAcceptance',
      'blocksSourceMutation',
      'resolvedAt',
    ],
    ['ownerSurface', 'resolutionNotes'],
  ),
  sourceMutationCompletionReviewIndex: fields(
    [
      'indexId',
...
const sourceMutationCompletionReviewRules = [
  {
    id: 'source-mutation-completion-review-requires-current-completion',
    rule:
      'source mutation completion review can only bind to one current source mutation completion record and its finalized post-apply audit review acceptance chain',
  },
  {
    id: 'source-mutation-completion-review-is-not-source-mutation',
    rule:
      'source mutation completion review status may mark review-acceptance readiness, but it cannot execute review, mutate accepted records, apply patches, mutate source, or execute remediation',
  },
  {
    id: 'source-mutation-completion-review-requires-reviewer-and-decision-notes',
    rule:
      'source mutation completion reviewer note refs, review decision note refs, completion decision note refs, clean baseline proof, exact scope lock, target lock, and baseline digest must be present before review acceptance can be considered',
  },
  {
    id: 'source-mutation-completion-review-requires-verification-dry-run-and-rollback-proof',
    rule:
      'patch draft refs, diff preview refs, verification output refs, dry-run proof refs, rollback proof refs, source-of-truth refs, task ledger refs, and negative evidence clearance must be present before source mutation completion review acceptance can be considered',
  },
  {
    id: 'failed-stale-broad-dirty-or-mutating-completion-review-blocks-acceptance',
    rule:
      'stale completion review proof, stale completion proof, stale review acceptance proof, dirty or untracked baseline, changed patch or diff proof, failed verification, missing rollback proof, missing reviewer note, missing review decision note, unresolved negative evidence, unapproved file touches, or any attempted source mutation blocks completion review acceptance readiness',
  },
];
...
const requiredFieldsSatisfied = Object.values(sourceMutationCompletionReviewSchema).every(
...
const ok =
  ...
  sourceSummary.harnessMentionsSourceMutationCompletionReview &&
  sourceSummary.completionReadinessMentionsSourceMutationCompletionReview &&
  sourceSummary.ledgerMentionsSourceMutationCompletionReview &&
  sourceSummary.verificationIncludesSourceMutationCompletionReview &&
  sourceSummary.sourceMutationCompletionReviewAcceptanceNextDocumented &&
  ...
  sourceSummary.sourceMutationCompletionReviewSeparateFromMutation &&
  sourceSummary.sourceMutationCompletionReviewAcceptanceStillBlocked &&
...
const payload = {
  ok,
  mode: 'growth-remediation-source-mutation-completion-review-status',
  posture: 'local-read-only-remediation-source-mutation-completion-review-contract',
  currentHead: {
  ...
  schemaVersion: 'growth-remediation-source-mutation-completion-review-status/v0',
  sourceSummary,
  vocabulary: {
    sourceMutationCompletionReviewStates: SOURCE_MUTATION_COMPLETION_REVIEW_STATES,
    sourceMutationCompletionReviewDecisionTypes: SOURCE_MUTATION_COMPLETION_REVIEW_DECISION_TYPES,
    sourceMutationCompletionReviewEvidenceTypes: SOURCE_MUTATION_COMPLETION_REVIEW_EVIDENCE_TYPES,
    sourceMutationCompletionReviewBlockerTypes: SOURCE_MUTATION_COMPLETION_REVIEW_BLOCKER_TYPES,
  },
  sourceMutationCompletionReviewSchema,
  sourceMutationCompletionReviewRules,
  sourceMutationCompletionReviewState: {
    realSourceMutationCompletionReviewFileAdopted: false,
    discoveredSourceMutationCompletionReviewRecords: 0,
    sourceMutationCompletionReviewAcceptanceAllowed: false,
    sourceMutationAllowed: false,
    acceptedRecordMutationAllowed: false,
    rollbackExecutionAllowed: false,
    remediationExecutionAllowed: false,
    currentStatus: 'contract-only-no-active-source-mutation-completion-review',
  },
  readiness: {
    requiredFieldsSatisfied,
    sourceMutationCompletionReviewRecordTypes: Object.keys(sourceMutationCompletionReviewSchema)
      .length,
    ...
    sourceMutationCompletionReviewAndMutationSeparate: true,
    sourceMutationCompletionReviewAcceptanceAllowed: false,
    sourceMutationAllowed: false,
    acceptedRecordMutationAllowed: false,
    rollbackExecutionAllowed: false,
    ...
    readyForSourceMutationCompletionReviewAcceptanceStatus: true,
  },
  nextRecommendedSlice: {
    ...
    reason:
      'Source mutation completion review is now modeled as read-only; the next safe slice should define completion review acceptance readiness without applying patches or mutating source.',
