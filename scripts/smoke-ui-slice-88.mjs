...
assert.match(councilConfigJs, /id: 'intake'[\s\S]*surface: 'mission'/);
assert.match(councilConfigJs, /id: 'council'[\s\S]*surface: 'council'/);
assert.match(councilConfigJs, /id: 'execution'[\s\S]*surface: 'execution'/);
assert.match(councilConfigJs, /id: 'deliverables'[\s\S]*surface: 'deliverables'/);
...
assert.match(appJs, /handleSurfaceChange\(actionButton\.dataset\.targetSurface \|\| 'mission'\)/);
