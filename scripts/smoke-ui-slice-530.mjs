...
console.log(
  JSON.stringify(
    {
      ok: true,
      harnessExecutionVisibleResultPreviewBackgroundFollowup: {
        insertionPoint: 'visibleExecutionResultRegister->previewExcerpt->backgroundDepth',
        marker: 'visible result preview excerpt uses stronger background depth',
      },
    },
    null,
    2,
