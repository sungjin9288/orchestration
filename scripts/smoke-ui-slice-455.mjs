...
assert.match(
  stylesCss,
  /\.surface\[data-surface="execution"\] \.relation-strip-hidden-compact > \.form-actions-hidden-compact\s*\{[\s\S]*gap:\s*7px 8px;[\s\S]*padding:\s*11px 11px 12px;[\s\S]*border-radius:\s*10px;/s,
);
