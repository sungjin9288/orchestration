...
console.log(
  JSON.stringify(
    {
      ok: true,
      harnessExecutionHiddenResultPreviewFontSizeFollowup: {
        insertionPoint: 'hiddenExecutionResultRegister->hiddenPreviewExcerpt->fontSizeDensity',
        marker: 'hidden result preview excerpt uses compact evidence density',
      },
    },
    null,
    2,
