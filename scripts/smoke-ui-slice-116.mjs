...
assert.match(appJs, /해결 뒤 흐름은 영향 셀과 현재 guard를 따라 이어집니다\./);
...
assert.match(appJs, /commit-package 아티팩트를 만들고 commit 승인 안건을 엽니다\. 외부 전달은 계속 막아 둡니다\./);
assert.match(appJs, /로컬 커밋을 실행하고 commit-result 아티팩트로 이어집니다\. 외부 전달은 계속 비활성입니다\./);
