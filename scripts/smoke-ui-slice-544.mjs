...
console.log(
  JSON.stringify(
    {
      ok: true,
      harnessExecutionHiddenOperatorContextLineHeightFollowup: {
        insertionPoint: 'hiddenExecutionResultRegister->hiddenOperatorContextGroup->supportingCopyRhythm',
        marker: 'hidden operator-context copy uses tighter rhythm',
      },
    },
    null,
    2,
