...
async function main() {
  ...
  try {
    ...
    assert.equal(stateBefore.schemaVersion, 17);
    ...
    delete schema9.sequences.staffingPlan;
    delete schema9.deliveryPackageAcceptances;
    delete schema9.staffingPlans;
    ...
    writeState(futureRoot, { ...stateAfter, schemaVersion: 18 });
    assert.throws(
