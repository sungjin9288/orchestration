...
assert.match(appJs, /\$\{escapeHtml\(lineItem\.typeLabel\)\}/);
assert.match(appJs, /\$\{escapeHtml\(lineItem\.text\)\}/);
...
assert.doesNotMatch(appJs, /\$\{escapeHtml\(getHarnessOutputBriefTypeLabel\(line\.type\)\)\}/);
