...
assert.match(app, /function renderTaskboardOpsEntrySignalRow\(entries = \[\]\)/);
...
assert.match(app, /class="taskboard-ops-entry-signal-row"/);
assert.match(app, /class="taskboard-ops-entry-signal taskboard-ops-entry-signal-\$\{escapeHtml\(entry\.surface\)\}"/);
assert.match(app, /class="taskboard-ops-entry-signal-dot taskboard-ops-entry-signal-dot-\$\{escapeHtml\(entry\.tone\)\}"/);
assert.match(app, /class="taskboard-ops-entry-signal-label"/);
assert.match(app, /class="taskboard-ops-entry-signal-status"/);
