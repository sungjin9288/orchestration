...
assert.match(opsEntrySignals, /export function getAdvancedOpsEntrySignals\(options = \{\}\)/);
assert.match(opsEntrySignals, /export function renderAdvancedOpsEntrySignalRow\(entries = \[\]\)/);
...
assert.match(opsEntrySignals, /class="advanced-ops-entry-signal-row"/);
assert.match(
  opsEntrySignals,
...
assert.match(opsEntrySignals, /class="advanced-ops-entry-signal-label"/);
assert.match(opsEntrySignals, /class="advanced-ops-entry-signal-status"/);
