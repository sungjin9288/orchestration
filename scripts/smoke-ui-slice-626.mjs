...
assert.match(harnessLabels, /resultTitle:\s*\{\s*policyReport: '최근 정책 리포트',\s*execution: '최근 실행 결과',\s*\}/);
assert.match(harnessLabels, /return getHarnessExecutionLabel\(execution, 'resultTitle'\);/);
