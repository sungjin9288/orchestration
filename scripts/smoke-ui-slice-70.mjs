...
assert.match(appJs, /플래너 실행을 시작하기 전에 태스크를 먼저 선택하세요\./);
assert.match(appJs, /설계 실행을 시작하기 전에 태스크를 먼저 선택하세요\./);
assert.match(appJs, /태스크 분해 실행을 시작하기 전에 태스크를 먼저 선택하세요\./);
