...
assert.match(
  stylesCss,
  /\.surface\[data-surface="execution"\] \.relation-strip-hidden-compact > \.form-actions-hidden-compact\s*\{[\s\S]*position:\s*relative;[\s\S]*border-radius:\s*10px;[\s\S]*border:\s*1px solid rgba\(33,\s*57,\s*49,\s*0\.1\);[\s\S]*background:\s*[\s\S]*linear-gradient\(180deg,\s*rgba\(255,\s*255,\s*255,\s*0\.84\),\s*rgba\(243,\s*247,\s*249,\s*0\.94\)\);/s,
);
assert.match(
  stylesCss,
