...
assert.match(runbook, /Dogfood Run 041 retained-evidence docs are being recorded locally before destructive cleanup/);
...
assert.match(handoff, /Dogfood Run 041 retained-evidence is being recorded locally before destructive cleanup/);
assert.match(handoff, /Dogfood Run 041 retained linked worktree path `\/Users\/sungjin\/dev\/personal\/orchestration--v1-dogfood-runner-038` and branch `worktree\/v1-dogfood-runner-038` remain retained until retained-evidence is committed and destructive cleanup removes them/);
