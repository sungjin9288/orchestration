...
assert.match(handoff, /Dogfood Run 034 retained-evidence commit `e11eaf0` was created locally before cleanup/);
...
assert.match(handoff, /Dogfood Run 034 retained-evidence is committed locally as `e11eaf0`/);
