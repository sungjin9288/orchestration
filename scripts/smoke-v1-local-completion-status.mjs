...
assert.match(handoff, /localDevelopmentComplete=false` while Dogfood Run 013 retained linked worktree cleanup remains approval-blocked and evidence docs remain local/);
