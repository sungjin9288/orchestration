...
assert.match(handoff, /retained-evidence commit `e2c2ff3` preserved the intentionally dirty linked worktree evidence before cleanup/);
...
assert.match(handoff, /Dogfood Run 039 retained linked worktree path `\/Users\/sungjin\/dev\/personal\/orchestration--v1-dogfood-runner-036` and branch `worktree\/v1-dogfood-runner-036` have been removed after retained-evidence commit `e2c2ff3` was preserved/);
