...
assert.match(runbook, /V1 dogfood result triage has been recorded through Dogfood Run 001 through Dogfood Run 039/);
...
assert.match(runbook, /Dogfood Run 039 retained-evidence docs are being recorded locally before destructive cleanup/);
assert.match(handoff, /last clean\/published v1 development baseline is `main` at `6301c6d5deebc68937ba043ce9f396f199c17366`/);
assert.match(handoff, /Dogfood Run 039 executed from that clean\/published baseline/);
...
assert.match(handoff, /Dogfood Run 039 retained-evidence is being recorded locally before destructive cleanup/);
assert.match(handoff, /Dogfood Run 039 retained linked worktree path `\/Users\/sungjin\/dev\/personal\/orchestration--v1-dogfood-runner-036` and branch `worktree\/v1-dogfood-runner-036` remain retained until retained-evidence is committed and destructive cleanup removes them/);
