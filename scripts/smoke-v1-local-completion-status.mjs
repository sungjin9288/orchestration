...
assert.match(handoff, /Dogfood Run 037 retained-evidence commit `98a8122` was created locally before cleanup/);
...
assert.match(handoff, /Dogfood Run 037 retained-evidence is committed locally as `98a8122`/);
