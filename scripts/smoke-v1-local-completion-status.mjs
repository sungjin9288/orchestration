...
assert.match(handoff, /Dogfood Run 036 retained-evidence commit `993c992` was created locally before cleanup/);
...
assert.match(handoff, /Dogfood Run 036 retained-evidence is committed locally as `993c992`/);
