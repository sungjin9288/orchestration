...
assert.match(
  appJs,
  /data-harness-execution-history-item-packet="true"[\s\S]*?data-harness-execution-history-action-shelf="true"[\s\S]*?<div class="form-actions form-actions-inline form-actions-compact">/,
);
