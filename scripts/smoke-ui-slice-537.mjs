...
console.log(
  JSON.stringify(
    {
      ok: true,
      harnessExecutionHiddenRunContextLineHeightFollowup: {
        insertionPoint: 'hiddenExecutionResultRegister->hiddenRunContextGroup->copyRhythm',
        marker: 'hidden run-context copy uses tighter summary rhythm',
      },
    },
    null,
    2,
