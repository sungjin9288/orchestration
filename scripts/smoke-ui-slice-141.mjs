...
assert.match(app, /class="mission-empty-copy">위 접수 데스크에서 첫 안건을 만들면 이곳에 바로 쌓입니다\.<\/p>/);
assert.match(app, /class="mission-empty-copy">왼쪽 목록에서 안건을 고르거나 위 데스크에서 새 안건을 접수합니다\.<\/p>/);
