...
assert.match(appJs, /function getMissionLoopStatus\(mission, previews = \{\}\)/);
assert.match(appJs, /stageLabel: 'Discover'/);
assert.match(appJs, /stageLabel: 'Plan'/);
assert.match(appJs, /stageLabel: 'Execute'/);
assert.match(appJs, /stageLabel: 'Verify'/);
assert.match(appJs, /stageLabel: 'Iterate'/);
assert.match(appJs, /stopCondition: '회의 초안 필요'/);
assert.match(appJs, /stopCondition: '결론 승인 필요'/);
assert.match(appJs, /stopCondition: '사람 승인 대기'/);
assert.match(appJs, /stopCondition: '루프 종료됨'/);
