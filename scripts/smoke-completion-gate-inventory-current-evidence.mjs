...
const inventoryGateRows = [
  ...
  /\| Completion gate inventory current evidence \| pass \| `node scripts\/smoke-completion-gate-inventory-current-evidence\.mjs`, `node scripts\/verification_status\.mjs` \| Current-head inventory evidence is pinned to aggregate `271\/271`, UI QA `73\/73`,[\s\S]*DEC-161 Agent Operations Desk visual redesign, and DEC-162 through DEC-164 multi-agent completion planning\. \| Keep this smoke in aggregate so gate inventory counts do not drift behind README, UI QA, or growth routing evidence\. \|/,
  ...
  /\| AI Company multi-agent completion planning \| pass \| `DEC-162`, `DEC-163`, `DEC-164`, `docs\/113_ai-company-multi-agent-completion-plan\.md`, `docs\/114_ai-company-durable-staffing-plan-implementation-decision-handoff\.md`, `node scripts\/smoke-ai-company-multi-agent-completion-planning\.mjs` \|/,
];
