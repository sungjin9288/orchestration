...
assert.match(
  stylesCss,
  /\.surface\[data-surface="execution"\] \.relation-strip-hidden-compact \[data-harness-result-hidden-preview="true"\]\s*\{[\s\S]*min-height:\s*168px;[\s\S]*border:\s*1px solid rgba\(55,\s*93,\s*120,\s*0\.(?:16|22|24)\);/s,
);
