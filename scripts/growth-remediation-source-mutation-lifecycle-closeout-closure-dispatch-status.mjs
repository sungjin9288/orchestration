...
const MODE = 'growth-remediation-source-mutation-lifecycle-closeout-closure-dispatch-status';
...
const CLOSURE_DISPATCH_STATES = [
  'source-mutation-lifecycle-closeout-closure-dispatch-not-started',
  'source-mutation-lifecycle-closeout-closure-dispatch-ready',
  'source-mutation-lifecycle-closeout-closure-dispatch-blocked',
  'source-mutation-lifecycle-closeout-closure-dispatch-ready-for-closure-execution-contract',
  'source-mutation-lifecycle-closeout-closure-dispatch-rejected',
  'source-mutation-lifecycle-closeout-closure-dispatch-deferred',
  ...
  'stale-source-mutation-lifecycle-closeout-closure-dispatch-blocked',
  'closed-no-action',
];

const CLOSURE_DISPATCH_DECISION_TYPES = [
  ...
  'request-source-mutation-lifecycle-closeout-closure-dispatch-criteria',
  'request-source-mutation-lifecycle-closeout-closure-dispatch-decision-note',
  'request-negative-evidence-clearance',
  'reject-source-mutation-lifecycle-closeout-closure-dispatch',
  'defer-source-mutation-lifecycle-closeout-closure-dispatch',
  'hold-baseline',
];

const CLOSURE_DISPATCH_EVIDENCE_TYPES = [
  ...
  'source-mutation-lifecycle-closeout-closure-execution-readiness-criteria',
...
const CLOSURE_DISPATCH_BLOCKER_TYPES = [
  ...
  'source-mutation-lifecycle-closeout-closure-dispatch-criteria-missing',
  'source-mutation-lifecycle-closeout-closure-dispatch-decision-note-missing',
...
function summarizeSources(sources) {
  ...
  return {
    ...
    sourceMutationLifecycleCloseoutClosureExecutionReadinessDocumented:
    ...
    sourceMutationLifecycleCloseoutClosureDispatchImplemented: /mode: MODE/.test(
      dispatchStatus,
    ),
    ...
    harnessMentionsSourceMutationLifecycleCloseoutClosureDispatch:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-dispatch-status/.test(
        harnessBaseline,
      ),
    completionReadinessMentionsSourceMutationLifecycleCloseoutClosureDispatch:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-dispatch-status/.test(
        completionReadiness,
      ),
    ledgerMentionsSourceMutationLifecycleCloseoutClosureDispatch:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-dispatch-status-readonly-post-m7-853/.test(
        todo,
      ),
    verificationIncludesSourceMutationLifecycleCloseoutClosureDispatch:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-dispatch-status/.test(
        verificationStatus,
      ),
    ...
    currentSourceMutationLifecycleCloseoutClosureExecutionReadinessDocumented:
      /current source mutation lifecycle closeout closure execution readiness record/.test(plan),
    ...
    sourceMutationLifecycleCloseoutClosureExecutionReadinessCriteriaRefsDocumented:
      /source mutation lifecycle closeout closure execution readiness criteria refs/.test(plan),
    sourceMutationLifecycleCloseoutClosureExecutionReadinessDecisionNoteRefsDocumented:
      /source mutation lifecycle closeout closure execution readiness decision note refs/.test(
        plan,
      ),
    ...
    sourceMutationLifecycleCloseoutClosureDispatchSeparateFromMutation:
      /source mutation lifecycle closeout closure dispatch status stays separate from actual source mutation execution/.test(
        plan,
      ),
    sourceMutationLifecycleCloseoutClosureDispatchStillBlocked:
...
const sourceMutationLifecycleCloseoutClosureDispatchSchema = {
  sourceMutationLifecycleCloseoutClosureDispatchRecord: fields(
    [
  ...
  sourceMutationLifecycleCloseoutClosureDispatchDecision: fields(
    [
      'decisionId',
      'sourceMutationLifecycleCloseoutClosureDispatchId',
      'sourceMutationLifecycleCloseoutClosureExecutionReadinessId',
  ...
  sourceMutationLifecycleCloseoutClosureDispatchBlocker: fields(
    [
      'blockerId',
      'sourceMutationLifecycleCloseoutClosureDispatchId',
      'sourceMutationLifecycleCloseoutClosureExecutionReadinessId',
  ...
  sourceMutationLifecycleCloseoutClosureDispatchIndex: fields(
    [
      'indexId',
...
const sourceMutationLifecycleCloseoutClosureDispatchRules = [
  {
    id: 'source-mutation-lifecycle-closeout-closure-dispatch-requires-current-execution-readiness-chain',
    rule:
      'source mutation lifecycle closeout closure dispatch can only bind to one current lifecycle closeout closure execution readiness record and its current lifecycle closeout chain',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-dispatch-is-not-source-mutation',
    rule:
      'source mutation lifecycle closeout closure dispatch status may mark closure execution readiness, but it cannot close the lifecycle, mutate accepted records, apply patches, mutate source, execute remediation, commit, push, or release',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-dispatch-requires-criteria-and-decision-notes',
    rule:
      'lifecycle closeout closure dispatch criteria refs and lifecycle closeout closure dispatch decision note refs must be present before closure execution can be considered',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-dispatch-requires-verification-dry-run-and-rollback-proof',
    rule:
      'clean baseline proof, exact scope lock, target lock, baseline digest, patch draft refs, diff preview refs, verification output refs, dry-run proof refs, rollback proof refs, source-of-truth refs, task ledger refs, and negative evidence clearance must be present before source mutation lifecycle closeout closure execution can be considered',
  },
  {
    id: 'failed-stale-broad-dirty-or-mutating-lifecycle-closeout-closure-dispatch-blocks-execution',
    rule:
      'stale dispatch proof, stale execution readiness proof, stale closure authorization proof, stale closure readiness proof, stale review acceptance proof, dirty or untracked baseline, changed patch or diff proof, failed verification, missing rollback proof, missing closure dispatch criteria, missing closure dispatch decision note, unresolved negative evidence, unapproved file touches, or any attempted source mutation blocks lifecycle closeout closure execution',
  },
];
...
const requiredFieldsSatisfied = Object.values(
  sourceMutationLifecycleCloseoutClosureDispatchSchema,
...
const payload = {
  ...
  schemaVersion: 'growth-remediation-source-mutation-lifecycle-closeout-closure-dispatch-status/v0',
  sourceSummary,
  vocabulary: {
    sourceMutationLifecycleCloseoutClosureDispatchStates: CLOSURE_DISPATCH_STATES,
    sourceMutationLifecycleCloseoutClosureDispatchDecisionTypes:
      CLOSURE_DISPATCH_DECISION_TYPES,
    sourceMutationLifecycleCloseoutClosureDispatchEvidenceTypes: CLOSURE_DISPATCH_EVIDENCE_TYPES,
    sourceMutationLifecycleCloseoutClosureDispatchBlockerTypes: CLOSURE_DISPATCH_BLOCKER_TYPES,
  },
  sourceMutationLifecycleCloseoutClosureDispatchSchema,
  sourceMutationLifecycleCloseoutClosureDispatchRules,
  sourceMutationLifecycleCloseoutClosureDispatchState: {
    realSourceMutationLifecycleCloseoutClosureDispatchFileAdopted: false,
    discoveredSourceMutationLifecycleCloseoutClosureDispatchRecords: 0,
    ...
    currentStatus: 'contract-only-no-active-source-mutation-lifecycle-closeout-closure-dispatch',
  },
  readiness: {
    requiredFieldsSatisfied,
    sourceMutationLifecycleCloseoutClosureDispatchRecordTypes: Object.keys(
      sourceMutationLifecycleCloseoutClosureDispatchSchema,
    ).length,
    ...
    sourceMutationLifecycleCloseoutClosureDispatchCriteriaRequired: true,
    sourceMutationLifecycleCloseoutClosureDispatchDecisionNoteRequired: true,
    negativeEvidenceClearanceRequired: true,
    sourceMutationLifecycleCloseoutClosureDispatchAndMutationSeparate: true,
    executionAllowed: false,
    dispatchAllowed: false,
    lifecycleClosed: false,
    sourceMutationAllowed: false,
    ...
    readyForSourceMutationLifecycleCloseoutClosureExecutionStatus: true,
  },
  nextRecommendedSlice: {
    ...
    reason:
      'Source mutation lifecycle closeout closure dispatch is now modeled as read-only; the next safe slice should check closure execution without lifecycle closure, patch application, or source mutation.',
