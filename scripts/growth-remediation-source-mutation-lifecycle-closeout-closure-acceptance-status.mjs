...
const MODE = 'growth-remediation-source-mutation-lifecycle-closeout-closure-acceptance-status';
...
const CLOSURE_ACCEPTANCE_STATES = [
  'source-mutation-lifecycle-closeout-closure-acceptance-not-started',
  'source-mutation-lifecycle-closeout-closure-acceptance-ready',
  'source-mutation-lifecycle-closeout-closure-acceptance-blocked',
  'source-mutation-lifecycle-closeout-closure-acceptance-ready-for-finalization-contract',
  'source-mutation-lifecycle-closeout-closure-acceptance-rejected',
  'source-mutation-lifecycle-closeout-closure-acceptance-deferred',
  ...
  'stale-source-mutation-lifecycle-closeout-closure-acceptance-blocked',
  'closed-no-action',
];

const CLOSURE_ACCEPTANCE_DECISION_TYPES = [
  ...
  'reject-source-mutation-lifecycle-closeout-closure-acceptance',
  'defer-source-mutation-lifecycle-closeout-closure-acceptance',
  'hold-baseline',
];

const CLOSURE_ACCEPTANCE_EVIDENCE_TYPES = [
...
const CLOSURE_ACCEPTANCE_BLOCKER_TYPES = [
  ...
  'source-mutation-lifecycle-closeout-closure-acceptance-status-attempts-lifecycle-close',
];
...
function summarizeSources(sources) {
  ...
  return {
    ...
    harnessMentionsSourceMutationLifecycleCloseoutClosureAcceptance:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-acceptance-status/.test(
        harnessBaseline,
      ),
    completionReadinessMentionsSourceMutationLifecycleCloseoutClosureAcceptance:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-acceptance-status/.test(
        completionReadiness,
      ),
    ledgerMentionsSourceMutationLifecycleCloseoutClosureAcceptance:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-acceptance-status-readonly-post-m7-862/.test(
        todo,
      ),
    verificationIncludesSourceMutationLifecycleCloseoutClosureAcceptance:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-acceptance-status/.test(
        verificationStatus,
      ),
    ...
    sourceMutationLifecycleCloseoutClosureAcceptanceSeparateFromMutation:
      /source mutation lifecycle closeout closure acceptance status stays separate from actual source mutation execution/.test(
        plan,
      ),
    sourceMutationLifecycleCloseoutClosureAcceptanceStillBlocked:
      /without accepting closure(?:,| or)\s+closing the lifecycle(?:,| or)\s+applying patches(?:,| or)\s+mutating source/.test(
        plan,
      ),
...
const sourceMutationLifecycleCloseoutClosureAcceptanceSchema = {
  sourceMutationLifecycleCloseoutClosureAcceptanceRecord: fields(
    [
  ...
  sourceMutationLifecycleCloseoutClosureAcceptanceDecision: fields(
    [
      'decisionId',
      'sourceMutationLifecycleCloseoutClosureAcceptanceId',
      'sourceMutationLifecycleCloseoutClosureReviewAcceptanceId',
  ...
  sourceMutationLifecycleCloseoutClosureAcceptanceBlocker: fields(
    [
      'blockerId',
      'sourceMutationLifecycleCloseoutClosureAcceptanceId',
      'sourceMutationLifecycleCloseoutClosureReviewAcceptanceId',
  ...
  sourceMutationLifecycleCloseoutClosureAcceptanceIndex: fields(
    [
      'indexId',
...
const sourceMutationLifecycleCloseoutClosureAcceptanceRules = [
  {
    id: 'source-mutation-lifecycle-closeout-closure-acceptance-requires-current-acceptance-chain',
    rule:
      'source mutation lifecycle closeout closure acceptance status can only bind to one current closure review acceptance record and its current lifecycle closeout chain',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-acceptance-is-not-finalization-or-source-mutation',
    rule:
      'source mutation lifecycle closeout closure acceptance status may mark finalization readiness, but it cannot accept closure, close the lifecycle, mutate accepted records, apply patches, mutate source, execute remediation, commit, push, or release',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-acceptance-requires-criteria-decision-and-reviewer-notes',
    rule:
      'closure acceptance criteria refs, closure acceptance decision note refs, closure review acceptance criteria refs, closure review acceptance decision note refs, closure review criteria refs, closure review decision note refs, closure criteria refs, closure decision note refs, closure result acceptance criteria refs, closure result acceptance decision note refs, and closure result reviewer note refs must be present before closure finalization status can be considered',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-acceptance-requires-verification-dry-run-and-rollback-proof',
    rule:
      'clean baseline proof, exact scope lock, target lock, baseline digest, patch draft refs, diff preview refs, verification output refs, dry-run proof refs, rollback proof refs, source-of-truth refs, task ledger refs, and negative evidence clearance must be present before source mutation lifecycle closeout closure finalization can be considered',
  },
  {
    id: 'failed-stale-broad-dirty-or-mutating-lifecycle-closeout-closure-acceptance-blocks-finalization',
    rule:
      'stale closure acceptance proof, stale closure review acceptance proof, stale closure review proof, stale closure proof, stale result acceptance proof, stale review acceptance proof, stale result review proof, stale result proof, stale execution proof, dirty or untracked baseline, changed patch or diff proof, failed verification, missing rollback proof, missing closure acceptance criteria, missing closure acceptance decision note, missing closure review acceptance criteria, missing closure review acceptance decision note, missing closure review criteria, missing closure review decision note, missing closure criteria, missing closure decision note, missing result acceptance criteria, missing result acceptance decision note, missing reviewer note, unresolved negative evidence, unapproved file touches, or any attempted finalization, source mutation, or lifecycle close blocks lifecycle closeout closure finalization',
  },
];
...
const requiredFieldsSatisfied = Object.values(
  sourceMutationLifecycleCloseoutClosureAcceptanceSchema,
...
const payload = {
  ...
  sourceSummary,
  vocabulary: {
    sourceMutationLifecycleCloseoutClosureAcceptanceStates: CLOSURE_ACCEPTANCE_STATES,
    sourceMutationLifecycleCloseoutClosureAcceptanceDecisionTypes:
      CLOSURE_ACCEPTANCE_DECISION_TYPES,
    sourceMutationLifecycleCloseoutClosureAcceptanceEvidenceTypes:
      CLOSURE_ACCEPTANCE_EVIDENCE_TYPES,
    sourceMutationLifecycleCloseoutClosureAcceptanceBlockerTypes:
      CLOSURE_ACCEPTANCE_BLOCKER_TYPES,
  },
  sourceMutationLifecycleCloseoutClosureAcceptanceSchema,
  sourceMutationLifecycleCloseoutClosureAcceptanceRules,
  sourceMutationLifecycleCloseoutClosureAcceptanceState: {
    realSourceMutationLifecycleCloseoutClosureAcceptanceFileAdopted: false,
    discoveredSourceMutationLifecycleCloseoutClosureAcceptanceRecords: 0,
    closureFinalizationAllowed: false,
  ...
  readiness: {
    requiredFieldsSatisfied,
    sourceMutationLifecycleCloseoutClosureAcceptanceRecordTypes: Object.keys(
      sourceMutationLifecycleCloseoutClosureAcceptanceSchema,
    ).length,
    ...
    sourceMutationLifecycleCloseoutClosureAcceptanceAndMutationSeparate: true,
    readyForSourceMutationLifecycleCloseoutClosureFinalizationStatus: true,
    closureFinalizationAllowed: false,
    closureAccepted: false,
    lifecycleClosed: false,
    sourceMutationAllowed: false,
  ...
  nextRecommendedSlice: {
    ...
    reason:
      'Source mutation lifecycle closeout closure acceptance status is now modeled as read-only; the next safe slice should define closure finalization status without final lifecycle closure, patch application, or source mutation.',
