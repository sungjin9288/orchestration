...
const vnextDevelopmentAuditSourceEvidence = {
  ...
  proposalDraftHumanReviewDecisionPacket: {
    contains: [
      ...
      'consumed-by-accept-review-evidence-only-decision',
  ...
  proposalDraftHumanReviewStatus: {
    contains: [
...
const implemented = [
  ...
  {
    area: 'proposal draft human review',
    evidence: [
      'docs/44_proposal-draft-human-review.md',
      'docs/01_decision-log.md#DEC-072',
      'src/runtime/proposal-draft-reviews.js',
      'scripts/smoke-proposal-draft-human-review.mjs',
      'scripts/vnext-proposal-draft-human-review-status.mjs',
    ],
  ...
  {
    area: 'proposal draft human review evidence decision',
    evidence: [
      'docs/46_proposal-draft-human-review-evidence-decision.md',
      'docs/01_decision-log.md#DEC-074',
      'scripts/vnext-proposal-draft-human-review-evidence-decision-status.mjs',
    ],
