...
const lifecycleCloseFocusEvidence = [
  /The active close-out slice is\s+`growth-lifecycle-close-finalization-acceptance-status-recheck-smoke-readability-post-m7-2395`/,
  /keeps\s+the\s+lifecycle-close-finalization-acceptance status evidence current without changing the already grouped\s+focused smoke/,
