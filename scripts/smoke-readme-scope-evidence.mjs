...
const completionFocusEvidence = [
  ...
  /required `1\/1`, informational `206\/206`, total `207\/207`/,
  /UI QA is required `36\/36`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `207\/207`, UI QA `36\/36`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `207\/207`, UI QA `36\/36`, zero-open backlog/,
