...
const completionFocusEvidence = [
  ...
  /Current runtime remains schema v13 with no MemoryCandidate\s+preview implementation/,
  ...
  /required `1\/1`, informational `218\/218`, total `219\/219`/,
  /UI QA is required `40\/40`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `219\/219`, UI QA `40\/40`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `219\/219`, UI QA `40\/40`, zero-open backlog/,
