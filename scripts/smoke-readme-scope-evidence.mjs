...
const completionFocusEvidence = [
  ...
  /The later DEC-166 StaffingPlan record remains unbound to this\s+Council entry path/,
  /DEC-167 and DEC-168 now define but do not implement one immutable Council-first\s+StaffingEntry binding/,
  ...
  /DEC-161 browser baseline plus DEC-162 through\s+DEC-168 StaffingPlan implementation and Council-binding planning evidence passes aggregate required\s+`1\/1`, informational `272\/272`, total `273\/273`, and UI QA required `74\/74`/,
