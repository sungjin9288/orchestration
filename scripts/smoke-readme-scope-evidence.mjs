...
const completionFocusEvidence = [
  /The current development focus is post-completion lifecycle-close-review-acceptance status recheck\s+evidence close-out/,
...
const lifecycleCloseFocusEvidence = [
  /The active close-out slice is\s+`growth-lifecycle-close-review-acceptance-status-recheck-smoke-readability-post-m7-2399`/,
  /keeps\s+the\s+lifecycle-close-review-acceptance status evidence current without changing the already grouped\s+focused smoke/,
  ...
  /source\s+close-review-acceptance-status script, focused smoke, runtime behavior, UI behavior,\s+provider configuration, memory persistence, proposal generation\/application, source mutation\s+authority, commit, push, connector reach, automation, and lifecycle semantics remain unchanged/,
];
