...
const completionFocusEvidence = [
  ...
  /DEC-170 and DEC-171 plan one explicit local\s+dependency-ready role step with durable attempt evidence but do not implement it/,
  /Provider-backed\s+WorkOrders, memory persistence expansion, autonomous scheduling, source\/profile mutation, approval\s+bypass, and runtime-agent commit\/push\/release remain blocked/,
  ...
  /DEC-161 browser baseline plus DEC-162 through\s+DEC-169 StaffingPlan and StaffingEntry implementation evidence plus DEC-170 through DEC-171 Stage 3\s+planning evidence pass aggregate required `1\/1`, informational `274\/274`, total `275\/275`, and UI QA\s+required `75\/75`/,
