...
const completionFocusEvidence = [
  ...
  /Schema-v12, durable candidate\s+lifecycle/,
  ...
  /required `1\/1`, informational `211\/211`, total `212\/212`/,
  /UI QA is required `38\/38`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `212\/212`, UI QA `38\/38`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `212\/212`, UI QA `38\/38`, zero-open backlog/,
