...
const completionFocusEvidence = [
  ...
  /DEC-159 passes aggregate required `1\/1`, informational\s+`267\/267`, total `268\/268`, and UI QA required `71\/71`/,
  /Focused browser checks at 1280x720 and\s+390x844 cover Mission and Taskboard/,
