...
const completionFocusEvidence = [
  ...
  /No\s+runtime\/API\/UI implementation is approved yet/,
  ...
  /Mission\/WorkOrder\/prompt\/policy injection, memory\s+application, automatic retrieval\/ranking\/recommendation/,
  ...
  /required `1\/1`, informational `230\/230`, total `231\/231`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `231\/231`, UI QA `44\/44`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `231\/231`, UI QA `44\/44`, zero-open backlog/,
