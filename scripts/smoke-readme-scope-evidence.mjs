...
const completionFocusEvidence = [
  ...
  /required `1\/1`, informational `185\/185`, total `186\/186`/,
  /UI QA is required `29\/29`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `186\/186`, UI QA `29\/29`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `186\/186`, UI QA `29\/29`, zero-open backlog/,
