...
const lifecycleCloseFocusEvidence = [
  /The active close-out slice is\s+`growth-lifecycle-close-finalization-status-recheck-smoke-readability-post-m7-2329`/,
  /keeps\s+the\s+lifecycle-close-finalization status evidence current without changing the already grouped focused\s+smoke/,
