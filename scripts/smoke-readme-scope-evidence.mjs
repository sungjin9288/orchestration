...
const completionFocusEvidence = [
  /The current development focus is the read-only proposal generation planning decision packet/,
  /previous post-completion explicit-entry and vNext audit maintenance-route slices are closed/,
  /default completion baseline has zero automatic implementation backlog/,
  /first concrete next\s+gate is `proposal generation planning decision required`/,
  ...
  /required `1\/1`, informational `169\/169`, total `170\/170`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `170\/170`, UI QA `28\/28`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `170\/170`, UI QA `28\/28`, zero-open backlog/,
