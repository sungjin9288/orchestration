...
const completionFocusEvidence = [
  ...
  /current state remains\s+schema v6 with response-only previews and no durable WorkOrder records/,
  ...
  /required `1\/1`, informational `191\/191`, total `192\/192`/,
  /UI QA is required `31\/31`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `192\/192`, UI QA `31\/31`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `192\/192`, UI QA `31\/31`, zero-open backlog/,
