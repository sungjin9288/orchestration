...
const completionFocusEvidence = [
  ...
  /DEC-161 browser baseline plus DEC-162 through\s+DEC-169 StaffingPlan and StaffingEntry implementation evidence, DEC-170 through DEC-172 Stage 3\s+scheduler evidence, and DEC-173 through DEC-176 Stage 4A planning and response-only implementation\s+evidence plus DEC-177 through DEC-179 Stage 4B planning, handoff, and fixed first-attempt\s+implementation evidence plus DEC-180 through DEC-182 Stage 4C retry planning, handoff, and exact\s+implementation evidence plus DEC-183 through DEC-185 Stage 6A inspect-only planning, handoff, and\s+implementation evidence plus DEC-186 through DEC-188 Stage 5 Reviewer rework preview planning,\s+handoff, and response-only implementation\s+evidence pass the aggregate and UI QA gates/,
