...
assert.match(readme, /The latest implementation lane combined the operator-approved source mutation slice/);
assert.match(readme, /Coordinator request\/decision\/artifact-content builders now live under/);
