...
const completionFocusEvidence = [
  ...
  /response-only preview with `persisted=false`/,
  /Runtime\/API\/UI\s+implementation, schema-v12, durable candidate lifecycle/,
  ...
  /required `1\/1`, informational `209\/209`, total `210\/210`/,
  /UI QA is required `37\/37`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `210\/210`, UI QA `37\/37`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `210\/210`, UI QA `37\/37`, zero-open backlog/,
