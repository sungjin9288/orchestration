...
const completionFocusEvidence = [
  ...
  /next gate is `proposal draft\s+human review decision required`/,
  ...
  /required `1\/1`, informational `175\/175`, total `176\/176`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `176\/176`, UI QA `28\/28`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `176\/176`, UI QA `28\/28`, zero-open backlog/,
