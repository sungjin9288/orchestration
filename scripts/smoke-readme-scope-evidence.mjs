...
const completionFocusEvidence = [
  ...
  /shell-free allowlisted `node --check` QA against Builder-changed files/,
  ...
  /required `1\/1`, informational `194\/194`, total `195\/195`/,
  /UI QA is required `32\/32`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `195\/195`, UI QA `32\/32`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `195\/195`, UI QA `32\/32`, zero-open backlog/,
