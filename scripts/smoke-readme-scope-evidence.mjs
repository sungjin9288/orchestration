...
const completionFocusEvidence = [
  ...
  /DEC-161 browser baseline plus DEC-162 through\s+DEC-169 StaffingPlan and StaffingEntry implementation evidence, DEC-170 through DEC-172 Stage 3\s+scheduler evidence, and DEC-173\/174 Stage 4A planning evidence pass aggregate required `1\/1`,\s+informational `276\/276`, total `277\/277`, and UI QA\s+required `76\/76`/,
