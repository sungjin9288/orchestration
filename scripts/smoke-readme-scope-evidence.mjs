...
const completionFocusEvidence = [
  ...
  /next gate is `fielded proposal draft\s+human review outcome required`/,
  ...
  /required `1\/1`, informational `176\/176`, total `177\/177`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `177\/177`, UI QA `28\/28`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `177\/177`, UI QA `28\/28`, zero-open backlog/,
