...
const completionFocusEvidence = [
  ...
  /Schema v14, durable records, exact inspection, and snapshots remain unchanged/,
  ...
  /No schema\/runtime\/API\/UI\s+implementation exists/,
  ...
  /required `1\/1`, informational `227\/227`, total `228\/228`/,
  /UI QA is required `43\/43`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `228\/228`, UI QA `43\/43`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `228\/228`, UI QA `43\/43`, zero-open backlog/,
