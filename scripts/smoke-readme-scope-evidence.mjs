...
const completionFocusEvidence = [
  ...
  /required `1\/1`, informational `203\/203`, total `204\/204`/,
  /UI QA is required `35\/35`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `204\/204`, UI QA `35\/35`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `204\/204`, UI QA `35\/35`, zero-open backlog/,
