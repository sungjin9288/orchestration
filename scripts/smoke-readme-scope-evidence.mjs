...
const completionFocusEvidence = [
  /The current development focus is post-completion lifecycle-close-acceptance\s+status recheck evidence close-out/,
...
const lifecycleCloseFocusEvidence = [
  /The active close-out slice is\s+`growth-lifecycle-close-acceptance-status-recheck-smoke-readability-post-m7-2463`/,
  /keeps\s+the\s+lifecycle-close-acceptance status evidence current without changing\s+the already grouped focused smoke/,
  ...
  /source\s+lifecycle-close-acceptance-status script, focused smoke, runtime behavior, UI behavior,\s+provider configuration, memory persistence, proposal generation\/application, source mutation\s+authority, commit, push, connector reach, automation, and lifecycle semantics remain unchanged/,
];
