...
const completionFocusEvidence = [
  ...
  /stale-evidence rejection, rollback,\s+quarantine, focused-smoke, and aggregate-verification requirements/,
  /The plan does not approve implementation/,
  /Provider-assisted generation, durable record creation,\s+proposal application, memory persistence, runtime\/UI\/source mutation, commit, and push remain\s+blocked/,
  /next gate is `proposal generation implementation decision required`/,
  ...
  /required `1\/1`, informational `171\/171`, total `172\/172`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `172\/172`, UI QA `28\/28`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `172\/172`, UI QA `28\/28`, zero-open backlog/,
