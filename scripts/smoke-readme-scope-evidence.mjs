...
const completionFocusEvidence = [
  ...
  /DEC-161 browser baseline plus DEC-162 through\s+DEC-169 StaffingPlan and StaffingEntry implementation evidence and DEC-170 through DEC-172 Stage 3\s+scheduler evidence pass aggregate required `1\/1`, informational `275\/275`, total `276\/276`, and UI QA\s+required `76\/76`/,
