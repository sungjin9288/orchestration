...
const completionFocusEvidence = [
  ...
  /Provider-backed WorkOrders, memory persistence expansion, autonomous scheduling,\s+source\/profile mutation, approval bypass, and runtime-agent commit\/push\/release remain blocked/,
  ...
  /DEC-161 browser baseline plus DEC-162 through\s+DEC-166 planning and Durable StaffingPlan evidence passes aggregate required `1\/1`, informational\s+`271\/271`, total `272\/272`, and UI QA required `74\/74`/,
