...
const completionFocusEvidence = [
  ...
  /DEC-160 passes aggregate required `1\/1`, informational\s+`268\/268`, total `269\/269`, and UI QA required `72\/72`/,
  /Focused browser checks at 1440x900 and\s+390x844 cover the loaded Mission shell and the empty first-run project workspace/,
