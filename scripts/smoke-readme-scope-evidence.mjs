...
const completionFocusEvidence = [
  ...
  /next gate is `explicit downstream authority decision required`/,
  ...
  /required `1\/1`, informational `177\/177`, total `178\/178`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `178\/178`, UI QA `28\/28`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `178\/178`, UI QA `28\/28`, zero-open backlog/,
