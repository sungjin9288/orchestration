...
const completionFocusEvidence = [
  /The current development focus is post-completion lifecycle-close-finalization\s+status recheck evidence close-out/,
...
const lifecycleCloseFocusEvidence = [
  /The active close-out slice is\s+`growth-lifecycle-close-finalization-status-recheck-smoke-readability-post-m7-2464`/,
  /keeps\s+the\s+lifecycle-close-finalization status evidence current without changing\s+the already grouped focused smoke/,
  ...
  /source\s+lifecycle-close-finalization-status script, focused smoke, runtime behavior, UI behavior,\s+provider configuration, memory persistence, proposal generation\/application, source mutation\s+authority, commit, push, connector reach, automation, and lifecycle semantics remain unchanged/,
];
