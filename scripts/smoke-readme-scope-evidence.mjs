...
const completionFocusEvidence = [
  ...
  /Current schema v14 exact inspection\s+remains authoritative/,
  ...
  /required `1\/1`, informational `224\/224`, total `225\/225`/,
  /UI QA is required `42\/42`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `225\/225`, UI QA `42\/42`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `225\/225`, UI QA `42\/42`, zero-open backlog/,
