...
const completionFocusEvidence = [
  ...
  /required `1\/1`, informational `223\/223`, total `224\/224`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `224\/224`, UI QA `42\/42`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `224\/224`, UI QA `42\/42`, zero-open backlog/,
