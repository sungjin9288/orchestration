...
const completionFocusEvidence = [
  ...
  /Provider-backed WorkOrders, memory\s+persistence expansion, autonomous scheduling, source\/profile mutation, approval bypass, and\s+runtime-agent commit\/push\/release remain blocked/,
  ...
  /DEC-161 browser baseline plus DEC-162 through\s+DEC-169 StaffingPlan and StaffingEntry implementation evidence passes aggregate required\s+`1\/1`, informational `273\/273`, total `274\/274`, and UI QA required `75\/75`/,
