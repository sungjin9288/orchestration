...
const completionFocusEvidence = [
  ...
  /Durable StaffingPlan\s+runtime and schema implementation remain blocked/,
  /`DEC-162` reconciles current schema-v16 AI Company evidence/,
  ...
  /DEC-161 browser baseline plus DEC-162 through\s+DEC-165 planning evidence passes aggregate required `1\/1`, informational `270\/270`, total `271\/271`,\s+and UI QA required `73\/73`/,
