...
const completionFocusEvidence = [
  ...
  /required `1\/1`, informational `199\/199`, total `200\/200`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `200\/200`, UI QA `34\/34`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `200\/200`, UI QA `34\/34`, zero-open backlog/,
