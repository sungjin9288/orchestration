...
const lifecycleCloseFocusEvidence = [
  /The active close-out slice is\s+`growth-lifecycle-close-final-close-status-recheck-smoke-readability-post-m7-2369`/,
  /keeps\s+the\s+lifecycle-close-final-close status evidence current without changing the already grouped\s+focused smoke/,
