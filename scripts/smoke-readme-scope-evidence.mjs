...
const lifecycleCloseFocusEvidence = [
  /The active close-out slice is\s+`growth-lifecycle-close-status-recheck-smoke-readability-post-m7-2361`/,
  /keeps\s+the\s+lifecycle-close status evidence current without changing the already grouped\s+focused smoke/,
