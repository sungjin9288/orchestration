...
const lifecycleCloseFocusEvidence = [
  /The active close-out slice is\s+`growth-lifecycle-close-review-acceptance-status-recheck-smoke-readability-post-m7-2354`/,
  /keeps\s+the\s+lifecycle-close-review-acceptance status evidence current without changing the already grouped focused\s+smoke/,
