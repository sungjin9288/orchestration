...
const completionFocusEvidence = [
  ...
  /next gate is `inert draft human review required`/,
  ...
  /required `1\/1`, informational `173\/173`, total `174\/174`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `174\/174`, UI QA `28\/28`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `174\/174`, UI QA `28\/28`, zero-open backlog/,
