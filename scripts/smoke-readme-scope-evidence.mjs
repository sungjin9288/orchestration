...
const lifecycleCloseFocusEvidence = [
  /The active close-out slice is\s+`growth-lifecycle-close-finalization-status-recheck-smoke-readability-post-m7-2320`/,
  /keeps\s+the lifecycle-close-finalization status evidence current without changing the already grouped\s+focused smoke/,
  ...
  /source\s+close-finalization-status script, focused smoke, runtime behavior, UI behavior, provider\s+configuration, memory persistence, proposal generation\/application, source mutation authority,\s+commit, push, connector reach, automation, and lifecycle semantics remain unchanged/,
];
