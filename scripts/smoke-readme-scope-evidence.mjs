...
const completionFocusEvidence = [
  /The current development focus is post-completion lifecycle-close-final-close status recheck\s+evidence close-out/,
...
const lifecycleCloseFocusEvidence = [
  /The active close-out slice is\s+`growth-lifecycle-close-final-close-status-recheck-smoke-readability-post-m7-2351`/,
  /keeps\s+the\s+lifecycle-close-final-close status evidence current without changing the already grouped focused\s+smoke/,
