...
const completionFocusEvidence = [
  ...
  /required `1\/1`, informational `232\/232`, total `233\/233`/,
  /UI QA is required `45\/45`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `233\/233`, UI QA `45\/45`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `233\/233`, UI QA `45\/45`, zero-open backlog/,
