...
const lifecycleCloseFocusEvidence = [
  /The active close-out slice is\s+`growth-lifecycle-close-acceptance-status-recheck-smoke-readability-post-m7-2346`/,
  /keeps\s+the\s+lifecycle-close-acceptance status evidence current without changing the already grouped focused\s+smoke/,
