...
const lifecycleCloseFocusEvidence = [
  /The active close-out slice is\s+`growth-lifecycle-close-finalization-review-status-recheck-smoke-readability-post-m7-2420`/,
  /keeps\s+the\s+lifecycle-close-finalization-review status evidence current without changing the already grouped\s+focused smoke/,
