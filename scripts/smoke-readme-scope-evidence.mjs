...
const completionFocusEvidence = [
  ...
  /Mission done,\s+durable package persistence, automatic rework/,
  ...
  /Only durable\s+`reviewer-ready` or `qa-ready` boundaries are planned as resumable/,
  /Active or ambiguous Builder, Reviewer,\s+and QA stages are quarantine-only/,
  /schema-v8 migration, WorkflowCheckpoint persistence, recovery routes, resume\/cancel\s+execution/,
  ...
  /required `1\/1`, informational `197\/197`, total `198\/198`/,
  /UI QA is required `33\/33`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `198\/198`, UI QA `33\/33`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `198\/198`, UI QA `33\/33`, zero-open backlog/,
