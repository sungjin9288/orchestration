...
const completionFocusEvidence = [
  ...
  /required `1\/1`, informational `187\/187`, total `188\/188`/,
  /UI QA is required `30\/30`/,
...
const growthSourceEvidence = [
  ...
  /aggregate `188\/188`, UI QA `30\/30`, zero-open backlog/,
...
const completionVerificationEvidence = [
  ...
  /completion inventory counts,\s+aggregate `188\/188`, UI QA `30\/30`, zero-open backlog/,
