...
assert.match(councilConfigJs, /avatarLabel: '리드 아바타'/);
assert.match(councilConfigJs, /avatarLabel: '전략 아바타'/);
assert.match(councilConfigJs, /avatarLabel: '설계 아바타'/);
assert.match(councilConfigJs, /avatarLabel: '실행 아바타'/);
assert.match(councilConfigJs, /deskProp: '최종 판단판 · 승인 묶음'/);
assert.match(councilConfigJs, /deskProp: '우선순위 표 · 전략 메모'/);
assert.match(councilConfigJs, /deskProp: '경계 도면 · 구조 메모'/);
assert.match(councilConfigJs, /deskProp: '체크포인트 표 · 실행 큐'/);
