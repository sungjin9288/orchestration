...
const SCRIPT_PATH = 'scripts/growth-evidence-ledger/proposal-record-acceptance-finalization-review-acceptance-finalization-review-acceptance-finalization-status.mjs';
const PREVIOUS_STATUS = 'scripts/growth-evidence-ledger/proposal-record-acceptance-finalization-review-acceptance-finalization-review-acceptance-status.mjs';
const NEXT_SLICE = `${BASE}-review`;
const NEXT_COMMAND = 'node scripts/growth-evidence-ledger/proposal-record-acceptance-finalization-review-acceptance-finalization-review-acceptance-finalization-review-status.mjs';
const STATUS_LABEL =
  'Growth Evidence Ledger proposal record dry-run review acceptance finalization review acceptance finalization review acceptance finalization review acceptance finalization review acceptance finalization review acceptance finalization review acceptance finalization review acceptance finalization review acceptance finalization status';
...
function summarizeSources(sources, missingSources) {
  return {
    ...
    statusLedgered: sourceMentions(
      sources.todo,
      'growth-evidence-ledger-proposal-record-acceptance-finalization-review-acceptance-finalization-review-acceptance-finalization-alias-status-readonly-post-m7-1912',
    ),
    filenameLimitLessonCaptured: /filesystem filename limits/.test(sources.lessons),
    engineRoutesPastAcceptanceFinalizationReviewAcceptanceFinalization: sourceMentions(sources.engine, NEXT_SLICE),
    reflectionRoutesPastAcceptanceFinalizationReviewAcceptanceFinalization: sourceMentions(sources.reflection, NEXT_SLICE),
...
function buildBlockedActions(existingBlockedActions) {
  return [
    ...new Set([
      ...
      'accept-dry-run-finalization-review-acceptance-finalization-review-acceptance-finalization-review-acceptance-finalization-review-acceptance-finalization-as-approval',
      'promote-dry-run-finalization-review-acceptance-finalization-review-acceptance-finalization-review-acceptance-finalization-review-acceptance-finalization-to-record',
    ]),
  ];
}
...
function buildReadiness({ acceptanceEnvelope, finalizationEnvelope, sourceSummary }) {
  return {
    ...
    engineReflectionAdvanced:
      sourceSummary.engineRoutesPastAcceptanceFinalizationReviewAcceptanceFinalization && sourceSummary.reflectionRoutesPastAcceptanceFinalizationReviewAcceptanceFinalization,
...
function buildPayload() {
  ...
  return {
    ok,
    mode: MODE,
    posture: 'local-read-only-ledger-proposal-record-acceptance-finalization-review-acceptance-finalization-review-acceptance-finalization-alias',
    ...
    sourceSummary,
    inputStatuses: {
      proposalRecordAcceptanceFinalizationReviewAcceptanceFinalizationReviewAcceptanceAlias: {
