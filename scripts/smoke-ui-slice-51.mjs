...
assert.match(appJs, /placeholder="Mission title"/);
assert.match(appJs, /placeholder="What should the system make or improve\?"/);
assert.match(appJs, /placeholder="Scope limits or acceptance hints"/);

assert.doesNotMatch(appJs, /placeholder="Bounded mission title"/);
assert.doesNotMatch(appJs, /placeholder="What do you want the system to make or improve\?"/);
assert.doesNotMatch(appJs, /placeholder="Optional constraints, scope limits, or acceptance hints"/);
