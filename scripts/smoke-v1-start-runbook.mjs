...
assert.match(runbook, /Dogfood Run 023 retained linked worktree cleanup is pending explicit operator approval/);
...
assert.match(runbook, /inspect the retained Dogfood Run 023 evidence/);
...
assert.match(runbook, /previous baseline push was complete before Dogfood Run 023 execute/);
...
assert.match(runbook, /Dogfood Run 023 linked worktree remains retained dirty by design/);
assert.match(runbook, /commit Dogfood Run 023 retained-evidence docs locally/);
assert.match(runbook, /clean up the Dogfood Run 023 retained linked worktree and branch/);
...
assert.match(handoff, /Dogfood Run 023 has now been explicitly approved and executed as retained linked-worktree evidence/);
...
assert.match(handoff, /push had completed before the Dogfood Run 023 execute pass; Run 023 retained-evidence docs are ready for local evidence commit and later destructive cleanup approval/);
...
assert.match(handoff, /Dogfood Run 023 retained linked worktree remains dirty by design/);
assert.match(handoff, /Dogfood Run 001 through Dogfood Run 023 evidence is recorded/);
assert.match(handoff, /approve a local evidence commit for Dogfood Run 023 retained evidence/);
assert.match(handoff, /approve destructive cleanup for the Dogfood Run 023 retained linked worktree and branch/);
