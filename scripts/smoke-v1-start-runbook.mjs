...
assert.match(runbook, /Dogfood Run 019 retained linked worktree cleanup is pending explicit destructive approval/);
...
assert.match(runbook, /inspect the retained Dogfood Run 019 evidence/);
...
assert.match(runbook, /Dogfood Run 002, Run 004, Run 005, Run 006, Run 007, Run 008, Run 009, Run 010, Run 011, Run 012, Run 013, Run 014, Run 015, Run 016, Run 017, and Run 018 retained dogfood linked worktree cleanup is complete/);
assert.match(runbook, /Dogfood Run 019 linked worktree remains retained at `\/Users\/sungjin\/dev\/personal\/orchestration--v1-dogfood-runner-016`/);
assert.match(runbook, /commit Dogfood Run 019 retained evidence locally/);
assert.match(runbook, /clean up Dogfood Run 019 retained linked worktree after the retained-evidence commit/);
...
assert.match(handoff, /approve a local evidence commit for Dogfood Run 019 retained evidence/);
assert.match(handoff, /approve Dogfood Run 019 retained linked worktree cleanup after retained-evidence commit/);
