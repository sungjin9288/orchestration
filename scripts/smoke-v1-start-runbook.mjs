...
assert.match(runbook, /Recorded at `2026-05-03 21:37:20 \+0900` on published `main`/);
assert.match(runbook, /dogfood triage status: `Dogfood Run 001` through `Dogfood Run 021` recorded/);
assert.match(runbook, /node scripts\/v1-dogfood-linked-worktree-runner\.mjs --execute --slug v1-dogfood-runner-018/);
assert.match(runbook, /b033609b379e0407423b194819398202971d92e0/);
assert.match(runbook, /\/Users\/sungjin\/dev\/personal\/orchestration--v1-dogfood-runner-018/);
assert.match(runbook, /retained linked worktree status: retained dirty by design with `prompts\/builder\.md` marker mutation/);
assert.match(runbook, /Dogfood Run 021 retained linked worktree cleanup is pending explicit destructive approval/);
...
assert.match(runbook, /V1 dogfood result triage has been recorded through Dogfood Run 001 through Dogfood Run 021/);
...
assert.match(runbook, /inspect the retained Dogfood Run 021 evidence/);
...
assert.match(runbook, /previous baseline push was complete before Dogfood Run 021 execute/);
assert.match(runbook, /Dogfood Run 002, Run 004, Run 005, Run 006, Run 007, Run 008, Run 009, Run 010, Run 011, Run 012, Run 013, Run 014, Run 015, Run 016, Run 017, Run 018, Run 019, and Run 020 retained dogfood linked worktree cleanup is complete/);
assert.match(runbook, /Dogfood Run 021 worktree retained: `\/Users\/sungjin\/dev\/personal\/orchestration--v1-dogfood-runner-018`/);
assert.match(runbook, /commit Dogfood Run 021 retained evidence locally/);
assert.match(runbook, /clean up Dogfood Run 021 retained linked worktree after the retained-evidence commit/);
...
assert.match(handoff, /current local v1 development baseline is complete on `main` after the explicitly approved Dogfood Run 021 execute pass/);
...
assert.match(handoff, /push had completed before the Dogfood Run 021 execute pass; Run 021 retained-evidence docs are ready for local evidence commit and later publish approval/);
assert.match(handoff, /Dogfood Run 002, Run 004, Run 005, Run 006, Run 007, Run 008, Run 009, Run 010, Run 011, Run 012, Run 013, Run 014, Run 015, Run 016, Run 017, Run 018, Run 019, and Run 020 retained dogfood linked worktree cleanup has completed/);
assert.match(handoff, /Dogfood Run 001 through Dogfood Run 021 evidence is recorded/);
assert.match(handoff, /Dogfood Run 021 cleanup is pending explicit destructive approval/);
assert.match(handoff, /approve a local evidence commit for Dogfood Run 021 retained evidence/);
assert.match(handoff, /approve cleanup for the Dogfood Run 021 retained linked worktree after evidence commit/);
