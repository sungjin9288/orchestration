...
assert.match(runbook, /No dogfood linked worktree remains retained after Dogfood Run 013 cleanup/);
...
assert.match(handoff, /Dogfood Run 001 through Dogfood Run 013 evidence is recorded/);
assert.match(handoff, /approve a local evidence commit for Dogfood Run 013 cleanup-completed evidence/);
