...
assert.match(runbook, /Dogfood Run 010 retained linked worktree cleanup is pending explicit operator approval/);
...
assert.match(runbook, /V1 dogfood result triage has been recorded through Dogfood Run 001 through Dogfood Run 010/);
...
assert.match(runbook, /inspect the retained Dogfood Run 010 evidence/);
...
assert.match(runbook, /clean up Dogfood Run 010 retained linked worktree evidence/);
assert.match(runbook, /push is complete/);
assert.match(runbook, /Dogfood Run 002, Run 004, Run 005, Run 006, Run 007, Run 008, and Run 009 retained dogfood linked worktree cleanup is complete/);
assert.match(runbook, /Dogfood Run 010 linked worktree remains retained until explicit cleanup approval/);
...
assert.match(handoff, /push had completed before the Dogfood Run 010 execute pass; Dogfood Run 010 retained evidence is pending explicit cleanup approval/);
assert.match(handoff, /Dogfood Run 002, Run 004, Run 005, Run 006, Run 007, Run 008, and Run 009 retained dogfood linked worktree cleanup has completed/);
assert.match(handoff, /Dogfood Run 010 linked worktree remains retained/);
assert.match(handoff, /Dogfood Run 001 through Dogfood Run 010 evidence is recorded/);
