...
assert.match(runbook, /Recorded at `2026-05-02 14:28:25 \+0900` on published `main`/);
assert.match(runbook, /dogfood triage status: `Dogfood Run 001` through `Dogfood Run 019` recorded/);
assert.match(runbook, /node scripts\/v1-dogfood-linked-worktree-runner\.mjs --execute --slug v1-dogfood-runner-016/);
assert.match(runbook, /e456763ae600bc43810a04837196d289f9a2d2b4/);
assert.match(runbook, /\/Users\/sungjin\/dev\/personal\/orchestration--v1-dogfood-runner-016/);
assert.match(runbook, /retained linked worktree status: cleaned up after explicit destructive approval/);
assert.match(runbook, /Dogfood Run 019 retained linked worktree cleanup has completed/);
...
assert.match(runbook, /inspect the cleanup-completed Dogfood Run 019 evidence/);
...
assert.match(runbook, /previous baseline push was complete before Dogfood Run 019 execute/);
assert.match(runbook, /Dogfood Run 002, Run 004, Run 005, Run 006, Run 007, Run 008, Run 009, Run 010, Run 011, Run 012, Run 013, Run 014, Run 015, Run 016, Run 017, Run 018, and Run 019 retained dogfood linked worktree cleanup is complete/);
assert.match(runbook, /No dogfood linked worktree remains retained after Dogfood Run 019 cleanup/);
assert.match(runbook, /commit Dogfood Run 019 cleanup-completed evidence locally/);
...
assert.match(handoff, /current local v1 development baseline is complete on `main` after the explicitly approved Dogfood Run 019 execute and cleanup loop/);
...
assert.match(handoff, /push had completed before the Dogfood Run 019 execute pass; Run 019 cleanup-completed docs are ready for local evidence commit and later publish approval/);
...
assert.match(handoff, /Dogfood Run 001 through Dogfood Run 019 evidence is recorded/);
assert.match(handoff, /approve a local evidence commit for Dogfood Run 019 cleanup-completed evidence/);
