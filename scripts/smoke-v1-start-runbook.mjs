...
assert.match(runbook, /Dogfood Run 008 retained linked worktree cleanup is pending explicit operator approval/);
...
assert.match(runbook, /cleanup Dogfood Run 008 retained linked worktree/);
assert.match(runbook, /Dogfood Run 008 linked worktree remains dirty by design until explicit cleanup approval/);
...
assert.match(handoff, /Dogfood Run 001 through Dogfood Run 008 evidence is recorded/);
assert.match(handoff, /Dogfood Run 008 retained dogfood linked worktree cleanup is pending explicit operator approval/);
assert.match(handoff, /approve cleanup for Dogfood Run 008 retained linked worktree/);
