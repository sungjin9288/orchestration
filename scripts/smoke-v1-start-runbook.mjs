...
assert.match(runbook, /Dogfood Run 025 linked worktree path `\/Users\/sungjin\/dev\/personal\/orchestration--v1-dogfood-runner-022` and branch `worktree\/v1-dogfood-runner-022` have been removed/);
  ...
  JSON.stringify(
    {
      ...
      v1StartRunbook: {
        ...
        nextPriorityPinned: 'approval-gated publish choice after Dogfood Run 025 cleanup-completed evidence',
      },
    },
    null,
    2,
