...
assert.match(runbook, /inspect the recorded Dogfood Run 023 evidence/);
...
assert.match(runbook, /No dogfood linked worktree remains retained dirty by design after Dogfood Run 023 cleanup/);
...
assert.match(handoff, /no Dogfood Run 023 retained linked worktree remains/);
assert.match(handoff, /Dogfood Run 001 through Dogfood Run 023 evidence is recorded/);
assert.doesNotMatch(handoff, /approve a local evidence commit for Dogfood Run 023 retained evidence/);
assert.doesNotMatch(handoff, /approve destructive cleanup for the Dogfood Run 023 retained linked worktree and branch/);
