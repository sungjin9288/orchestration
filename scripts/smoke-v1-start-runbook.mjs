...
assert.match(runbook, /retained linked worktree status: dirty by design, `prompts\/builder\.md` modified/);
assert.match(runbook, /Dogfood Run 009 retained linked worktree cleanup is pending explicit operator approval/);
...
assert.match(runbook, /V1 dogfood result triage has been recorded through Dogfood Run 001 through Dogfood Run 009/);
...
assert.match(runbook, /Dogfood Run 002, Run 004, Run 005, Run 006, Run 007, and Run 008 retained dogfood linked worktree cleanup is complete/);
assert.match(runbook, /cleanup Dogfood Run 009 retained linked worktree/);
assert.match(runbook, /Dogfood Run 009 linked worktree remains dirty by design until explicit cleanup approval/);
...
assert.match(handoff, /push had completed before the Dogfood Run 009 execute pass/);
assert.match(handoff, /Dogfood Run 002, Run 004, Run 005, Run 006, Run 007, and Run 008 retained dogfood linked worktree cleanup has completed/);
assert.match(handoff, /Dogfood Run 001 through Dogfood Run 009 evidence is recorded/);
assert.match(handoff, /Dogfood Run 009 retained dogfood linked worktree cleanup is pending explicit operator approval/);
assert.match(handoff, /approve cleanup for Dogfood Run 009 retained linked worktree/);
