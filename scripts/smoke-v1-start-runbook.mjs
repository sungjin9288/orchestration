...
assert.match(runbook, /No dogfood linked worktree remains retained after Dogfood Run 010 cleanup/);
...
assert.match(handoff, /push had completed before the Dogfood Run 010 execute pass; final cleanup evidence is ready for publish after the cleanup commit/);
