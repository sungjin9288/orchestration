...
assert.match(runbook, /retained linked worktree status: cleaned up after explicit destructive approval/);
assert.match(runbook, /Dogfood Run 017 retained linked worktree cleanup has completed/);
...
assert.match(runbook, /inspect the cleanup-completed Dogfood Run 017 evidence/);
...
assert.match(runbook, /previous baseline push was complete before Dogfood Run 017 execute/);
...
assert.match(runbook, /No dogfood linked worktree remains retained after Dogfood Run 017 cleanup/);
assert.match(runbook, /commit Dogfood Run 017 cleanup-completed evidence locally/);
...
assert.match(handoff, /current local v1 development baseline is complete on `main` after the explicitly approved Dogfood Run 017 execute and cleanup loop/);
...
assert.match(handoff, /push had completed before the Dogfood Run 017 execute pass; Run 017 cleanup-completed docs are ready for local evidence commit and later publish approval/);
...
assert.match(handoff, /approve a local evidence commit for Dogfood Run 017 cleanup-completed evidence/);
