...
assert.match(runbook, /Dogfood Run 020 retained linked worktree cleanup is pending explicit destructive approval/);
...
assert.match(runbook, /inspect the retained Dogfood Run 020 evidence/);
...
assert.match(runbook, /Dogfood Run 020 worktree retained: `\/Users\/sungjin\/dev\/personal\/orchestration--v1-dogfood-runner-017`/);
assert.match(runbook, /commit Dogfood Run 020 retained evidence locally/);
assert.match(runbook, /clean up Dogfood Run 020 retained linked worktree after retained-evidence commit/);
...
assert.match(handoff, /approve a local evidence commit for Dogfood Run 020 retained evidence/);
assert.match(handoff, /approve Dogfood Run 020 retained linked worktree cleanup after the retained-evidence commit/);
