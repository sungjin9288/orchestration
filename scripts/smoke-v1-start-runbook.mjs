...
assert.match(runbook, /Recorded at `2026-05-02 13:00:23 \+0900` on published `main`/);
assert.match(runbook, /dogfood triage status: `Dogfood Run 001` through `Dogfood Run 018` recorded/);
assert.match(runbook, /node scripts\/v1-dogfood-linked-worktree-runner\.mjs --execute --slug v1-dogfood-runner-015/);
assert.match(runbook, /cef724b684d29bdf60b52967231921df8800c1b0/);
assert.match(runbook, /\/Users\/sungjin\/dev\/personal\/orchestration--v1-dogfood-runner-015/);
assert.match(runbook, /retained linked worktree status: retained dirty by design with `prompts\/builder\.md` marker mutation/);
assert.match(runbook, /Dogfood Run 018 retained linked worktree cleanup is pending explicit destructive approval/);
...
assert.match(runbook, /inspect the retained Dogfood Run 018 evidence/);
...
assert.match(runbook, /previous baseline push was complete before Dogfood Run 018 execute/);
assert.match(runbook, /Dogfood Run 002, Run 004, Run 005, Run 006, Run 007, Run 008, Run 009, Run 010, Run 011, Run 012, Run 013, Run 014, Run 015, Run 016, and Run 017 retained dogfood linked worktree cleanup is complete/);
assert.match(runbook, /Dogfood Run 018 linked worktree remains retained at `\/Users\/sungjin\/dev\/personal\/orchestration--v1-dogfood-runner-015`/);
assert.match(runbook, /commit Dogfood Run 018 retained evidence locally/);
assert.match(runbook, /clean up the Dogfood Run 018 retained linked worktree after the evidence commit/);
...
assert.match(handoff, /current local v1 development baseline is complete on `main` after the explicitly approved Dogfood Run 018 execute pass/);
...
assert.match(handoff, /push had completed before the Dogfood Run 018 execute pass; Run 018 retained-evidence docs are ready for local evidence commit and later publish approval/);
assert.match(handoff, /Dogfood Run 002, Run 004, Run 005, Run 006, Run 007, Run 008, Run 009, Run 010, Run 011, Run 012, Run 013, Run 014, Run 015, Run 016, and Run 017 retained dogfood linked worktree cleanup has completed/);
assert.match(handoff, /Dogfood Run 001 through Dogfood Run 018 evidence is recorded/);
assert.match(handoff, /Dogfood Run 018 retained linked worktree cleanup is pending explicit destructive approval/);
assert.match(handoff, /approve a local evidence commit for Dogfood Run 018 retained evidence/);
assert.match(handoff, /approve Dogfood Run 018 retained linked worktree cleanup after the retained-evidence commit/);
