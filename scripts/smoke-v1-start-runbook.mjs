...
assert.match(runbook, /Dogfood Run 024 retained linked worktree cleanup is pending explicit operator approval/);
...
assert.match(runbook, /inspect the retained Dogfood Run 024 evidence/);
...
assert.match(runbook, /commit Dogfood Run 024 retained-evidence docs locally/);
assert.match(runbook, /clean up the Dogfood Run 024 retained linked worktree and branch/);
assert.match(runbook, /Dogfood Run 023 retained-evidence docs were committed locally/);
assert.match(runbook, /Dogfood Run 002, Run 004, Run 005, Run 006, Run 007, Run 008, Run 009, Run 010, Run 011, Run 012, Run 013, Run 014, Run 015, Run 016, Run 017, Run 018, Run 019, Run 020, Run 021, Run 022, and Run 023 retained dogfood linked worktree cleanup is complete/);
assert.match(runbook, /Dogfood Run 024 linked worktree remains retained dirty by design/);
...
assert.match(handoff, /node scripts\/v1-local-completion-status\.mjs` reports the current local completion state, including push and dogfood execution approval gates/);
...
assert.match(handoff, /Dogfood Run 024 retained linked worktree remains dirty by design/);
assert.match(handoff, /Dogfood Run 001 through Dogfood Run 024 evidence is recorded/);
assert.match(handoff, /approve a local evidence commit for Dogfood Run 024 retained evidence/);
assert.match(handoff, /approve destructive cleanup for the Dogfood Run 024 retained linked worktree and branch/);
assert.match(handoff, /approve publishing the cleanup-completed evidence to `origin\/main` after cleanup is recorded/);
