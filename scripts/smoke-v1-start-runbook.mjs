...
assert.match(runbook, /Dogfood Run 011 retained linked worktree cleanup is pending explicit operator approval/);
...
assert.match(runbook, /inspect the retained Dogfood Run 011 evidence/);
...
assert.match(runbook, /clean up Dogfood Run 011 retained linked worktree evidence/);
assert.match(runbook, /push is complete/);
assert.match(runbook, /Dogfood Run 002, Run 004, Run 005, Run 006, Run 007, Run 008, Run 009, and Run 010 retained dogfood linked worktree cleanup is complete/);
assert.match(runbook, /Dogfood Run 011 linked worktree remains retained until explicit cleanup approval/);
...
assert.match(handoff, /Dogfood Run 001 through Dogfood Run 011 evidence is recorded/);
