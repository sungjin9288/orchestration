...
assert.match(runbook, /Recorded at `2026-05-01 18:44:06 \+0900` on published `main`/);
assert.match(runbook, /dogfood triage status: `Dogfood Run 001` through `Dogfood Run 015` recorded/);
assert.match(runbook, /node scripts\/v1-dogfood-linked-worktree-runner\.mjs --execute --slug v1-dogfood-runner-012/);
assert.match(runbook, /8d9aa3f2cce37c022be039c75be7bf11833ea66f/);
assert.match(runbook, /\/Users\/sungjin\/dev\/personal\/orchestration--v1-dogfood-runner-012/);
...
assert.match(runbook, /Dogfood Run 015 retained linked worktree cleanup is pending explicit approval/);
...
assert.match(runbook, /V1 dogfood result triage has been recorded through Dogfood Run 001 through Dogfood Run 015/);
...
assert.match(runbook, /inspect the retained Dogfood Run 015 evidence and approval blocker/);
...
assert.match(runbook, /Dogfood Run 002, Run 004, Run 005, Run 006, Run 007, Run 008, Run 009, Run 010, Run 011, Run 012, Run 013, and Run 014 retained dogfood linked worktree cleanup is complete/);
assert.match(runbook, /Dogfood Run 015 linked worktree remains retained until explicit cleanup approval/);
...
assert.match(handoff, /current local v1 development baseline is in retained-evidence state after the explicitly approved Dogfood Run 015 execute pass/);
...
assert.match(handoff, /push had completed before the Dogfood Run 015 execute pass; Run 015 retained-evidence docs are ready for local evidence commit and later publish approval/);
assert.match(handoff, /Dogfood Run 002, Run 004, Run 005, Run 006, Run 007, Run 008, Run 009, Run 010, Run 011, Run 012, Run 013, and Run 014 retained dogfood linked worktree cleanup has completed/);
assert.match(handoff, /Dogfood Run 001 through Dogfood Run 015 evidence is recorded/);
assert.match(handoff, /Dogfood Run 015 retained dogfood linked worktree cleanup is pending explicit operator approval/);
assert.match(handoff, /approve a local evidence commit for Dogfood Run 015 retained evidence/);
assert.match(handoff, /approve destructive cleanup for `\/Users\/sungjin\/dev\/personal\/orchestration--v1-dogfood-runner-012` and `worktree\/v1-dogfood-runner-012`/);
