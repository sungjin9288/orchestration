...
assert.match(runbook, /retained linked worktree status: dirty by design and retained until explicit destructive cleanup approval/);
assert.match(runbook, /Dogfood Run 014 retained linked worktree cleanup is pending explicit operator approval/);
...
assert.match(runbook, /inspect the latest retained Dogfood Run 014 evidence/);
...
assert.match(runbook, /Dogfood Run 002, Run 004, Run 005, Run 006, Run 007, Run 008, Run 009, Run 010, Run 011, Run 012, and Run 013 retained dogfood linked worktree cleanup is complete/);
assert.match(runbook, /remove the retained Dogfood Run 014 linked worktree and branch/);
assert.match(runbook, /Dogfood Run 014 linked worktree remains retained dirty by design/);
...
assert.match(handoff, /node scripts\/v1-local-completion-status\.mjs` reports `localDevelopmentComplete=false` while Dogfood Run 014 retained linked worktree cleanup remains approval-blocked and evidence docs remain local/);
...
assert.match(handoff, /Dogfood Run 001 through Dogfood Run 014 evidence is recorded locally/);
assert.match(handoff, /Dogfood Run 014 retained linked worktree cleanup is pending explicit operator approval/);
assert.match(handoff, /approve a local evidence commit for Dogfood Run 014 retained evidence/);
assert.match(handoff, /approve destructive cleanup for the retained Dogfood Run 014 linked worktree and branch/);
