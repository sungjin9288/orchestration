...
assert.match(runbook, /retained linked worktree status: cleaned up after explicit destructive approval/);
assert.match(runbook, /Dogfood Run 018 retained linked worktree cleanup has completed/);
...
assert.match(runbook, /inspect the cleanup-completed Dogfood Run 018 evidence/);
...
assert.match(runbook, /No dogfood linked worktree remains retained after Dogfood Run 018 cleanup/);
assert.match(runbook, /commit Dogfood Run 018 cleanup-completed evidence locally/);
...
assert.match(handoff, /approve a local evidence commit for Dogfood Run 018 cleanup-completed evidence/);
