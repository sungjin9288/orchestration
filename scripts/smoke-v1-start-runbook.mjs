...
assert.match(runbook, /Dogfood Run 002, Run 004, Run 005, Run 006, Run 007, Run 008, Run 009, Run 010, and Run 011 retained dogfood linked worktree cleanup is complete/);
assert.match(runbook, /No dogfood linked worktree remains retained after Dogfood Run 011 cleanup/);
