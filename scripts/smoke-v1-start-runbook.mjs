...
assert.match(runbook, /Recorded at `2026-05-01 22:39:32 \+0900` on published `main`/);
assert.match(runbook, /dogfood triage status: `Dogfood Run 001` through `Dogfood Run 016` recorded/);
assert.match(runbook, /node scripts\/v1-dogfood-linked-worktree-runner\.mjs --execute --slug v1-dogfood-runner-013/);
assert.match(runbook, /d9c13e00c937f427387be509fb1aa385fb15a1a0/);
assert.match(runbook, /\/Users\/sungjin\/dev\/personal\/orchestration--v1-dogfood-runner-013/);
assert.match(runbook, /retained linked worktree status: retained dirty by design with `prompts\/builder\.md` marker mutation/);
assert.match(runbook, /Dogfood Run 016 retained linked worktree cleanup is pending explicit destructive approval/);
...
assert.match(runbook, /V1 dogfood result triage has been recorded through Dogfood Run 001 through Dogfood Run 016/);
...
assert.match(runbook, /inspect the retained Dogfood Run 016 evidence/);
...
assert.match(runbook, /Dogfood Run 002, Run 004, Run 005, Run 006, Run 007, Run 008, Run 009, Run 010, Run 011, Run 012, Run 013, Run 014, and Run 015 retained dogfood linked worktree cleanup is complete/);
assert.match(runbook, /Dogfood Run 016 linked worktree remains retained at `\/Users\/sungjin\/dev\/personal\/orchestration--v1-dogfood-runner-013`/);
assert.match(runbook, /commit Dogfood Run 016 retained evidence locally/);
assert.match(runbook, /clean up the Dogfood Run 016 retained linked worktree after the evidence commit/);
...
assert.match(handoff, /current local v1 development baseline is complete on `main` after the explicitly approved Dogfood Run 016 execute pass/);
...
assert.match(handoff, /push had completed before the Dogfood Run 016 execute pass; Run 016 retained-evidence docs are ready for local evidence commit and later publish approval/);
assert.match(handoff, /Dogfood Run 002, Run 004, Run 005, Run 006, Run 007, Run 008, Run 009, Run 010, Run 011, Run 012, Run 013, Run 014, and Run 015 retained dogfood linked worktree cleanup has completed/);
assert.match(handoff, /Dogfood Run 016 retained linked worktree cleanup is pending explicit destructive approval/);
assert.match(handoff, /Dogfood Run 001 through Dogfood Run 016 evidence is recorded/);
assert.match(handoff, /approve a local evidence commit for Dogfood Run 016 retained evidence/);
assert.match(handoff, /approve Dogfood Run 016 retained linked worktree cleanup after the retained-evidence commit/);
