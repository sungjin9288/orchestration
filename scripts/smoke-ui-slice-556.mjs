...
console.log(
  JSON.stringify(
    {
      ok: true,
      harnessExecutionHiddenShowButtonShadowFollowup: {
        insertionPoint: 'hiddenExecutionResultRegister->hiddenActionShelf->showButtonLift',
        marker: 'hidden result show button uses light read-tier lift',
      },
    },
    null,
    2,
