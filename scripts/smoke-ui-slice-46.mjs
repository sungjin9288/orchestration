...
assert.match(appJs, /<strong class="mission-empty-title">선택된 안건 없음<\/strong>[\s\S]*?<p class="mission-empty-copy">왼쪽 목록에서 안건을 고르거나 위 입력선에서 새 안건을 접수합니다\.<\/p>/);
assert.match(appJs, /<strong class="mission-empty-title">미션 없음<\/strong>[\s\S]*?<p class="mission-empty-copy">위 접수 흐름에서 첫 안건을 만들면 이곳에 바로 쌓입니다\.<\/p>/);
