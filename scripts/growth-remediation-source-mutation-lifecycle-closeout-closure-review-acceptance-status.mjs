...
const CLOSURE_REVIEW_ACCEPTANCE_STATES = [
  'source-mutation-lifecycle-closeout-closure-review-acceptance-not-started',
  'source-mutation-lifecycle-closeout-closure-review-acceptance-ready',
  'source-mutation-lifecycle-closeout-closure-review-acceptance-blocked',
  'source-mutation-lifecycle-closeout-closure-review-acceptance-ready-for-closure-acceptance-contract',
  'source-mutation-lifecycle-closeout-closure-review-acceptance-rejected',
  'source-mutation-lifecycle-closeout-closure-review-acceptance-deferred',
  ...
  'stale-source-mutation-lifecycle-closeout-closure-review-acceptance-blocked',
  'closed-no-action',
];

const CLOSURE_REVIEW_ACCEPTANCE_DECISION_TYPES = [
  ...
  'request-source-mutation-lifecycle-closeout-closure-review-criteria',
  'request-source-mutation-lifecycle-closeout-closure-review-decision-note',
  'request-source-mutation-lifecycle-closeout-closure-criteria',
  'request-source-mutation-lifecycle-closeout-closure-decision-note',
  'request-source-mutation-lifecycle-closeout-closure-result-acceptance-criteria',
  'request-source-mutation-lifecycle-closeout-closure-result-acceptance-decision-note',
  'request-source-mutation-lifecycle-closeout-closure-result-reviewer-note',
  'request-negative-evidence-clearance',
  'reject-source-mutation-lifecycle-closeout-closure-review-acceptance',
  'defer-source-mutation-lifecycle-closeout-closure-review-acceptance',
  'hold-baseline',
];

const CLOSURE_REVIEW_ACCEPTANCE_EVIDENCE_TYPES = [
  'source-mutation-lifecycle-closeout-closure-review-acceptance-record',
  'source-mutation-lifecycle-closeout-closure-review-acceptance-criteria',
  'source-mutation-lifecycle-closeout-closure-review-acceptance-decision-note',
  'source-mutation-lifecycle-closeout-closure-review-record',
  'source-mutation-lifecycle-closeout-closure-review-criteria',
  'source-mutation-lifecycle-closeout-closure-review-decision-note',
  'source-mutation-lifecycle-closeout-closure-record',
  'source-mutation-lifecycle-closeout-closure-criteria',
  'source-mutation-lifecycle-closeout-closure-decision-note',
  'source-mutation-lifecycle-closeout-closure-result-acceptance-record',
  'source-mutation-lifecycle-closeout-closure-result-acceptance-criteria',
  'source-mutation-lifecycle-closeout-closure-result-acceptance-decision-note',
...
const CLOSURE_REVIEW_ACCEPTANCE_BLOCKER_TYPES = [
  'source-mutation-lifecycle-closeout-closure-review-acceptance-missing',
  'source-mutation-lifecycle-closeout-closure-review-acceptance-stale',
  'source-mutation-lifecycle-closeout-closure-review-acceptance-rejected',
  'source-mutation-lifecycle-closeout-closure-review-missing',
  'source-mutation-lifecycle-closeout-closure-review-stale',
  'source-mutation-lifecycle-closeout-closure-review-rejected',
  'source-mutation-lifecycle-closeout-closure-missing',
  'source-mutation-lifecycle-closeout-closure-stale',
  'source-mutation-lifecycle-closeout-closure-rejected',
  'source-mutation-lifecycle-closeout-closure-result-acceptance-missing',
  'source-mutation-lifecycle-closeout-closure-result-acceptance-stale',
  'source-mutation-lifecycle-closeout-closure-result-acceptance-rejected',
  ...
  'source-mutation-lifecycle-closeout-closure-review-acceptance-criteria-missing',
  'source-mutation-lifecycle-closeout-closure-review-acceptance-decision-note-missing',
  'source-mutation-lifecycle-closeout-closure-review-criteria-missing',
  'source-mutation-lifecycle-closeout-closure-review-decision-note-missing',
  'source-mutation-lifecycle-closeout-closure-criteria-missing',
  'source-mutation-lifecycle-closeout-closure-decision-note-missing',
  'source-mutation-lifecycle-closeout-closure-result-acceptance-criteria-missing',
  'source-mutation-lifecycle-closeout-closure-result-acceptance-decision-note-missing',
  ...
  'source-mutation-lifecycle-closeout-closure-review-acceptance-status-attempts-final-lifecycle-close',
...
function summarizeSources(sources) {
  ...
  return {
    ...
    sourceMutationLifecycleCloseoutClosureReviewDocumented:
      /Fifty-third Implemented Slice: `growth-remediation-source-mutation-lifecycle-closeout-closure-review-status`/.test(
        plan,
      ),
    sourceMutationLifecycleCloseoutClosureReviewAcceptanceDocumented:
    ...
    harnessMentionsSourceMutationLifecycleCloseoutClosureReviewAcceptance:
    ...
    ledgerMentionsSourceMutationLifecycleCloseoutClosureReviewAcceptance:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-review-acceptance-status-readonly-post-m7-861/.test(
        todo,
      ),
    verificationIncludesSourceMutationLifecycleCloseoutClosureReviewAcceptance:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-review-acceptance-status/.test(
        verificationStatus,
      ),
    ...
    sourceMutationLifecycleCloseoutClosureReviewAcceptanceSeparateFromMutation:
      /source mutation lifecycle closeout closure review acceptance status stays separate from actual source mutation execution/.test(
        plan,
      ),
    sourceMutationLifecycleCloseoutClosureReviewAcceptanceStillBlocked:
      /without accepting closure review acceptance(?:,| or)\s+accepting closure review(?:,| or)\s+closing the lifecycle(?:,| or)\s+applying patches(?:,| or)\s+mutating source/.test(
        plan,
      ),
...
const sourceMutationLifecycleCloseoutClosureReviewAcceptanceSchema = {
  sourceMutationLifecycleCloseoutClosureReviewAcceptanceRecord: fields(
    [
  ...
  sourceMutationLifecycleCloseoutClosureReviewAcceptanceDecision: fields(
    [
      'decisionId',
      'sourceMutationLifecycleCloseoutClosureReviewAcceptanceId',
      'sourceMutationLifecycleCloseoutClosureReviewId',
  ...
  sourceMutationLifecycleCloseoutClosureReviewAcceptanceBlocker: fields(
    [
      'blockerId',
      'sourceMutationLifecycleCloseoutClosureReviewAcceptanceId',
      'sourceMutationLifecycleCloseoutClosureReviewId',
  ...
  sourceMutationLifecycleCloseoutClosureReviewAcceptanceIndex: fields(
    [
      'indexId',
...
const sourceMutationLifecycleCloseoutClosureReviewAcceptanceRules = [
  {
    id: 'source-mutation-lifecycle-closeout-closure-review-acceptance-requires-current-review-chain',
    rule:
      'source mutation lifecycle closeout closure review acceptance status can only bind to one current lifecycle closeout closure review record and its current lifecycle closeout chain',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-review-acceptance-is-not-closure-acceptance-or-source-mutation',
    rule:
      'source mutation lifecycle closeout closure review acceptance status may mark closure acceptance readiness, but it cannot accept closure review, accept closure, close the lifecycle, mutate accepted records, apply patches, mutate source, execute remediation, commit, push, or release',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-review-acceptance-requires-criteria-decision-and-reviewer-notes',
    rule:
      'closure review acceptance criteria refs, closure review acceptance decision note refs, closure review criteria refs, closure review decision note refs, closure criteria refs, closure decision note refs, closure result acceptance criteria refs, closure result acceptance decision note refs, and closure result reviewer note refs must be present before closure acceptance status can be considered',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-review-acceptance-requires-verification-dry-run-and-rollback-proof',
    rule:
      'clean baseline proof, exact scope lock, target lock, baseline digest, patch draft refs, diff preview refs, verification output refs, dry-run proof refs, rollback proof refs, source-of-truth refs, task ledger refs, and negative evidence clearance must be present before source mutation lifecycle closeout closure acceptance can be considered',
  },
  {
    id: 'failed-stale-broad-dirty-or-mutating-lifecycle-closeout-closure-review-acceptance-blocks-closure-acceptance',
    rule:
      'stale closure review acceptance proof, stale closure review proof, stale closure proof, stale result acceptance proof, stale review acceptance proof, stale result review proof, stale result proof, stale execution proof, dirty or untracked baseline, changed patch or diff proof, failed verification, missing rollback proof, missing closure review acceptance criteria, missing closure review acceptance decision note, missing closure review criteria, missing closure review decision note, missing closure criteria, missing closure decision note, missing result acceptance criteria, missing result acceptance decision note, missing reviewer note, unresolved negative evidence, unapproved file touches, or any attempted closure acceptance, source mutation, or lifecycle close blocks lifecycle closeout closure acceptance',
  },
];
...
const requiredFieldsSatisfied = Object.values(
  sourceMutationLifecycleCloseoutClosureReviewAcceptanceSchema,
...
const payload = {
  ...
  sourceSummary,
  vocabulary: {
    sourceMutationLifecycleCloseoutClosureReviewAcceptanceStates:
      CLOSURE_REVIEW_ACCEPTANCE_STATES,
    sourceMutationLifecycleCloseoutClosureReviewAcceptanceDecisionTypes:
      CLOSURE_REVIEW_ACCEPTANCE_DECISION_TYPES,
    sourceMutationLifecycleCloseoutClosureReviewAcceptanceEvidenceTypes:
      CLOSURE_REVIEW_ACCEPTANCE_EVIDENCE_TYPES,
    sourceMutationLifecycleCloseoutClosureReviewAcceptanceBlockerTypes:
      CLOSURE_REVIEW_ACCEPTANCE_BLOCKER_TYPES,
  },
  sourceMutationLifecycleCloseoutClosureReviewAcceptanceSchema,
  sourceMutationLifecycleCloseoutClosureReviewAcceptanceRules,
  sourceMutationLifecycleCloseoutClosureReviewAcceptanceState: {
    realSourceMutationLifecycleCloseoutClosureReviewAcceptanceFileAdopted: false,
    discoveredSourceMutationLifecycleCloseoutClosureReviewAcceptanceRecords: 0,
    closureAcceptanceAllowed: false,
    closureReviewAccepted: false,
  ...
  readiness: {
    requiredFieldsSatisfied,
    sourceMutationLifecycleCloseoutClosureReviewAcceptanceRecordTypes: Object.keys(
      sourceMutationLifecycleCloseoutClosureReviewAcceptanceSchema,
    ).length,
    ...
    sourceMutationLifecycleCloseoutClosureReviewAcceptanceAndMutationSeparate: true,
    readyForSourceMutationLifecycleCloseoutClosureAcceptanceStatus: true,
    closureAcceptanceAllowed: false,
    closureReviewAccepted: false,
    closureAccepted: false,
    lifecycleClosed: false,
  ...
  nextRecommendedSlice: {
    ...
    reason:
      'Source mutation lifecycle closeout closure review acceptance status is now modeled as read-only; the next safe slice should define closure acceptance status without final lifecycle closure, patch application, or source mutation.',
