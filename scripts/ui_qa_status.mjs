...
const smokeChecks = [
  ...
  {
    id: 'ai-company-reviewer-rework-preview-ui-api',
    script: 'scripts/smoke-ui-slice-703.mjs',
    purpose:
  ...
  {
    id: 'ai-company-builder-rework-preflight-ui-api',
    script: 'scripts/smoke-ui-slice-706.mjs',
    purpose:
  ...
  {
    id: 'ai-company-reviewer-reexecution-ui-api',
    script: 'scripts/smoke-ui-slice-709.mjs',
    purpose:
  ...
  {
    id: 'ai-company-ops-safe-checkpoint-resume-ui-api',
    script: 'scripts/smoke-ui-slice-715.mjs',
    purpose:
