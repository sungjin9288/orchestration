...
assertContainsBacktickedAll(sources.handoff, proposalApplicationDecisionRequiredFields);
assertContainsBacktickedAll(sources.handoff, proposalApplicationDecisionOptions);
