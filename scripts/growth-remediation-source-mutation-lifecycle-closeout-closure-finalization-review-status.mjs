...
const CLOSURE_FINALIZATION_REVIEW_STATES = [
  'source-mutation-lifecycle-closeout-closure-finalization-review-not-started',
  'source-mutation-lifecycle-closeout-closure-finalization-review-ready',
  'source-mutation-lifecycle-closeout-closure-finalization-review-blocked',
  'source-mutation-lifecycle-closeout-closure-finalization-review-ready-for-acceptance-contract',
  'source-mutation-lifecycle-closeout-closure-finalization-review-rejected',
  'source-mutation-lifecycle-closeout-closure-finalization-review-deferred',
  ...
  'stale-source-mutation-lifecycle-closeout-closure-finalization-review-blocked',
  'closed-no-action',
];

const CLOSURE_FINALIZATION_REVIEW_DECISION_TYPES = [
  ...
  'reject-source-mutation-lifecycle-closeout-closure-finalization-review',
  'defer-source-mutation-lifecycle-closeout-closure-finalization-review',
  'hold-baseline',
];

const CLOSURE_FINALIZATION_REVIEW_EVIDENCE_TYPES = [
...
const CLOSURE_FINALIZATION_REVIEW_BLOCKER_TYPES = [
  ...
  'source-mutation-lifecycle-closeout-closure-finalization-review-status-attempts-lifecycle-close',
];
...
function summarizeSources(sources) {
  ...
  return {
    ...
    ledgerMentionsSourceMutationLifecycleCloseoutClosureFinalizationReview:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-finalization-review-status-readonly-post-m7-864/.test(
        todo,
      ),
    ...
    sourceMutationLifecycleCloseoutClosureFinalizationReviewSeparateFromMutation:
      /source mutation lifecycle closeout closure finalization review status stays separate from actual source mutation execution/.test(
        plan,
      ),
    sourceMutationLifecycleCloseoutClosureFinalizationReviewStillBlocked:
      /without accepting finalization review(?:,| or)\s+finalizing closure(?:,| or)\s+closing\s+the\s+lifecycle(?:,| or)\s+applying patches(?:,| or)\s+mutating source/.test(
        plan,
      ),
...
const sourceMutationLifecycleCloseoutClosureFinalizationReviewSchema = {
  sourceMutationLifecycleCloseoutClosureFinalizationReviewRecord: fields(
    [
  ...
  sourceMutationLifecycleCloseoutClosureFinalizationReviewDecision: fields(
    [
      'decisionId',
      'sourceMutationLifecycleCloseoutClosureFinalizationReviewId',
      'sourceMutationLifecycleCloseoutClosureFinalizationId',
  ...
  sourceMutationLifecycleCloseoutClosureFinalizationReviewBlocker: fields(
    [
      'blockerId',
      'sourceMutationLifecycleCloseoutClosureFinalizationReviewId',
      'sourceMutationLifecycleCloseoutClosureFinalizationId',
  ...
  sourceMutationLifecycleCloseoutClosureFinalizationReviewIndex: fields(
    [
      'indexId',
...
const sourceMutationLifecycleCloseoutClosureFinalizationReviewRules = [
  {
    id: 'source-mutation-lifecycle-closeout-closure-finalization-review-requires-current-review-chain',
    rule:
      'source mutation lifecycle closeout closure finalization review status can only bind to one current closure finalization record and its current lifecycle closeout chain',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-finalization-review-is-not-acceptance-finalization-or-source-mutation',
    rule:
      'source mutation lifecycle closeout closure finalization review status may mark acceptance readiness, but it cannot accept finalization review, finalize closure, close the lifecycle, mutate accepted records, apply patches, mutate source, execute remediation, commit, push, or release',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-finalization-review-requires-criteria-decision-and-reviewer-notes',
    rule:
      'closure finalization review criteria refs, closure finalization review decision note refs, closure finalization criteria refs, closure finalization decision note refs, closure acceptance criteria refs, closure acceptance decision note refs, and closure result reviewer note refs must be present before closure finalization review acceptance status can be considered',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-finalization-review-requires-verification-dry-run-and-rollback-proof',
    rule:
      'clean baseline proof, exact scope lock, target lock, baseline digest, patch draft refs, diff preview refs, verification output refs, dry-run proof refs, rollback proof refs, source-of-truth refs, task ledger refs, and negative evidence clearance must be present before source mutation lifecycle closeout closure finalization review acceptance can be considered',
  },
  {
    id: 'failed-stale-broad-dirty-or-mutating-lifecycle-closeout-closure-finalization-review-blocks-acceptance',
    rule:
      'stale closure finalization review proof, stale closure finalization proof, stale closure acceptance proof, dirty or untracked baseline, changed patch or diff proof, failed verification, missing rollback proof, missing closure finalization review criteria, missing closure finalization review decision note, missing closure finalization criteria, missing closure finalization decision note, missing closure acceptance criteria, missing closure acceptance decision note, missing reviewer note, unresolved negative evidence, unapproved file touches, or any attempted finalization-review acceptance, finalization, source mutation, or lifecycle close blocks lifecycle closeout closure finalization review acceptance',
  },
];
...
const requiredFieldsSatisfied = Object.values(
  sourceMutationLifecycleCloseoutClosureFinalizationReviewSchema,
...
const payload = {
  ...
  sourceSummary,
  vocabulary: {
    sourceMutationLifecycleCloseoutClosureFinalizationReviewStates:
      CLOSURE_FINALIZATION_REVIEW_STATES,
    sourceMutationLifecycleCloseoutClosureFinalizationReviewDecisionTypes:
      CLOSURE_FINALIZATION_REVIEW_DECISION_TYPES,
    sourceMutationLifecycleCloseoutClosureFinalizationReviewEvidenceTypes:
      CLOSURE_FINALIZATION_REVIEW_EVIDENCE_TYPES,
    sourceMutationLifecycleCloseoutClosureFinalizationReviewBlockerTypes:
      CLOSURE_FINALIZATION_REVIEW_BLOCKER_TYPES,
  },
  sourceMutationLifecycleCloseoutClosureFinalizationReviewSchema,
  sourceMutationLifecycleCloseoutClosureFinalizationReviewRules,
  sourceMutationLifecycleCloseoutClosureFinalizationReviewState: {
    realSourceMutationLifecycleCloseoutClosureFinalizationReviewFileAdopted: false,
    discoveredSourceMutationLifecycleCloseoutClosureFinalizationReviewRecords: 0,
    closureFinalizationReviewAcceptanceAllowed: false,
    ...
    currentStatus:
      'contract-only-no-active-source-mutation-lifecycle-closeout-closure-finalization-review',
  },
  readiness: {
    requiredFieldsSatisfied,
    sourceMutationLifecycleCloseoutClosureFinalizationReviewRecordTypes: Object.keys(
      sourceMutationLifecycleCloseoutClosureFinalizationReviewSchema,
    ).length,
    ...
    sourceMutationLifecycleCloseoutClosureFinalizationReviewAndMutationSeparate: true,
    readyForSourceMutationLifecycleCloseoutClosureFinalizationReviewAcceptanceStatus: true,
    closureFinalizationReviewAcceptanceAllowed: false,
    closureFinalizationReviewAccepted: false,
    closureFinalized: false,
    lifecycleClosed: false,
  ...
  nextRecommendedSlice: {
    ...
    reason:
      'Source mutation lifecycle closeout closure finalization review status is now modeled as read-only; the next safe slice should define closure finalization review acceptance status without final lifecycle closure, patch application, or source mutation.',
