...
const MODE = 'growth-remediation-source-mutation-lifecycle-closeout-closure-review-status';
...
const CLOSURE_REVIEW_STATES = [
  'source-mutation-lifecycle-closeout-closure-review-not-started',
  'source-mutation-lifecycle-closeout-closure-review-ready',
  'source-mutation-lifecycle-closeout-closure-review-blocked',
  ...
  'source-mutation-lifecycle-closeout-closure-review-deferred',
  ...
  'stale-source-mutation-lifecycle-closeout-closure-review-blocked',
  'closed-no-action',
];

const CLOSURE_REVIEW_DECISION_TYPES = [
  ...
  'reject-source-mutation-lifecycle-closeout-closure-review',
  'defer-source-mutation-lifecycle-closeout-closure-review',
  'hold-baseline',
];

const CLOSURE_REVIEW_EVIDENCE_TYPES = [
...
const CLOSURE_REVIEW_BLOCKER_TYPES = [
  ...
  'source-mutation-lifecycle-closeout-closure-review-status-attempts-final-lifecycle-close',
...
function summarizeSources(sources) {
  ...
  return {
    ...
    sourceMutationLifecycleCloseoutClosureDocumented:
    ...
    harnessMentionsSourceMutationLifecycleCloseoutClosureReview:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-review-status/.test(
        harnessBaseline,
      ),
    completionReadinessMentionsSourceMutationLifecycleCloseoutClosureReview:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-review-status/.test(
        completionReadiness,
      ),
    ledgerMentionsSourceMutationLifecycleCloseoutClosureReview:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-review-status-readonly-post-m7-860/.test(
        todo,
      ),
    verificationIncludesSourceMutationLifecycleCloseoutClosureReview:
      /growth-remediation-source-mutation-lifecycle-closeout-closure-review-status/.test(
        verificationStatus,
      ),
    ...
    sourceMutationLifecycleCloseoutClosureReviewSeparateFromMutation:
      /source mutation lifecycle closeout closure review status stays separate from actual source mutation execution/.test(
        plan,
      ),
    sourceMutationLifecycleCloseoutClosureReviewStillBlocked:
      /without accepting closure review(?:,| or)\s+closing the lifecycle(?:,| or)\s+applying patches(?:,| or)\s+mutating source/.test(
        plan,
      ),
...
const sourceMutationLifecycleCloseoutClosureReviewSchema = {
  sourceMutationLifecycleCloseoutClosureReviewRecord: fields(
    [
  ...
  sourceMutationLifecycleCloseoutClosureReviewDecision: fields(
    [
      'decisionId',
      'sourceMutationLifecycleCloseoutClosureReviewId',
      'sourceMutationLifecycleCloseoutClosureId',
  ...
  sourceMutationLifecycleCloseoutClosureReviewBlocker: fields(
    [
      'blockerId',
      'sourceMutationLifecycleCloseoutClosureReviewId',
      'sourceMutationLifecycleCloseoutClosureId',
  ...
  sourceMutationLifecycleCloseoutClosureReviewIndex: fields(
    [
      'indexId',
...
const sourceMutationLifecycleCloseoutClosureReviewRules = [
  {
    id: 'source-mutation-lifecycle-closeout-closure-review-requires-current-closure-chain',
    rule:
      'source mutation lifecycle closeout closure review status can only bind to one current lifecycle closeout closure record and its current lifecycle closeout chain',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-review-is-not-review-acceptance-or-source-mutation',
    rule:
      'source mutation lifecycle closeout closure review status may mark review acceptance readiness, but it cannot accept closure review, close the lifecycle, mutate accepted records, apply patches, mutate source, execute remediation, commit, push, or release',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-review-requires-criteria-decision-and-reviewer-notes',
    rule:
      'closure review criteria refs, closure review decision note refs, closure criteria refs, closure decision note refs, closure result acceptance criteria refs, closure result acceptance decision note refs, and closure result reviewer note refs must be present before closure review acceptance status can be considered',
  },
  {
    id: 'source-mutation-lifecycle-closeout-closure-review-requires-verification-dry-run-and-rollback-proof',
    rule:
      'clean baseline proof, exact scope lock, target lock, baseline digest, patch draft refs, diff preview refs, verification output refs, dry-run proof refs, rollback proof refs, source-of-truth refs, task ledger refs, and negative evidence clearance must be present before source mutation lifecycle closeout closure review acceptance can be considered',
  },
  {
    id: 'failed-stale-broad-dirty-or-mutating-lifecycle-closeout-closure-review-blocks-acceptance',
    rule:
      'stale closure review proof, stale closure proof, stale result acceptance proof, stale review acceptance proof, stale result review proof, stale result proof, stale execution proof, dirty or untracked baseline, changed patch or diff proof, failed verification, missing rollback proof, missing closure review criteria, missing closure review decision note, missing closure criteria, missing closure decision note, missing result acceptance criteria, missing result acceptance decision note, missing reviewer note, unresolved negative evidence, unapproved file touches, or any attempted review acceptance, source mutation, or lifecycle close blocks lifecycle closeout closure review acceptance',
  },
];
...
const requiredFieldsSatisfied = Object.values(
  sourceMutationLifecycleCloseoutClosureReviewSchema,
...
const payload = {
  ok,
  mode: MODE,
  posture: 'local-read-only-remediation-source-mutation-lifecycle-closeout-closure-review-contract',
  currentHead: {
  ...
  sourceSummary,
  vocabulary: {
    sourceMutationLifecycleCloseoutClosureReviewStates: CLOSURE_REVIEW_STATES,
    sourceMutationLifecycleCloseoutClosureReviewDecisionTypes: CLOSURE_REVIEW_DECISION_TYPES,
    sourceMutationLifecycleCloseoutClosureReviewEvidenceTypes: CLOSURE_REVIEW_EVIDENCE_TYPES,
    sourceMutationLifecycleCloseoutClosureReviewBlockerTypes: CLOSURE_REVIEW_BLOCKER_TYPES,
  },
  sourceMutationLifecycleCloseoutClosureReviewSchema,
  sourceMutationLifecycleCloseoutClosureReviewRules,
  sourceMutationLifecycleCloseoutClosureReviewState: {
    realSourceMutationLifecycleCloseoutClosureReviewFileAdopted: false,
    discoveredSourceMutationLifecycleCloseoutClosureReviewRecords: 0,
    closureReviewAcceptanceAllowed: false,
    ...
    currentStatus: 'contract-only-no-active-source-mutation-lifecycle-closeout-closure-review',
  },
  readiness: {
    requiredFieldsSatisfied,
    sourceMutationLifecycleCloseoutClosureReviewRecordTypes: Object.keys(
      sourceMutationLifecycleCloseoutClosureReviewSchema,
    ).length,
    ...
    sourceMutationLifecycleCloseoutClosureReviewAndMutationSeparate: true,
    readyForSourceMutationLifecycleCloseoutClosureReviewAcceptanceStatus: true,
    closureReviewAcceptanceAllowed: false,
    closureReviewAccepted: false,
    lifecycleClosed: false,
    sourceMutationAllowed: false,
  ...
  nextRecommendedSlice: {
    ...
    reason:
      'Source mutation lifecycle closeout closure review status is now modeled as read-only; the next safe slice should define closure review acceptance status without final lifecycle closure, patch application, or source mutation.',
