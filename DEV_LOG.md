...
- README 보완 필요:
  ...
  - `scripts/portfolio-share-status.mjs`는 package readiness, verified-link state, optional live-provider env visibility, remaining blockers를 upload나 live call 없이 read-only JSON으로 요약한다.
