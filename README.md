...
`growth-lifecycle-close-finalization-review-acceptance-status-recheck-smoke-readability-post-m7-2340`. It keeps the
lifecycle-close-finalization-review-acceptance status evidence current without changing the already grouped focused
