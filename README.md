...
`growth-lifecycle-close-review-status-recheck-smoke-readability-post-m7-2452`.
...
lifecycle-close-review-status script, focused smoke, runtime behavior, UI behavior,
