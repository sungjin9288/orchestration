...
`growth-lifecycle-close-acceptance-status-recheck-smoke-readability-post-m7-2355`. It keeps the
lifecycle-close-acceptance status evidence current without changing the already grouped focused
...
close-acceptance-status script, focused smoke, runtime behavior, UI behavior,
