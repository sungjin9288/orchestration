...
- `node scripts/smoke-ui-slice-328.mjs`, `334`, `335`, `336`, `337`, `380`, `382`, `383`, `384`,
  `385`, `386`, `387`, `388`, `605`, `606`, `612`, `613`, `616`, `620`, `621`, `625`, `626`, and `628`:
  harness helper-focused smokes for executed-at labels, hidden status summaries, output-channel
  tokens, visible token labels, policy-report predicates, policy-report copy fallback formatting,
  completion lead/output copy, preview text, request labels, input/output summary fallback values,
  result state tokens, and hidden/history output-brief action rendering.
