...
`growth-lifecycle-close-acceptance-status-recheck-smoke-readability-post-m7-2418`. It keeps the
lifecycle-close-acceptance status evidence current without changing the already grouped
