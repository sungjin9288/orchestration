...
- `node scripts/smoke-ui-slice-328.mjs`, `334`, `335`, `336`, `337`, `380`, `382`, `383`, `384`,
  ...
  tokens, visible token labels, visible token markup handoff, policy-report predicates, execution
  packet copy fallback formatting, policy-report copy fallback formatting, completion lead/output
  copy, preview text, request labels, input/output summary fallback values, result state tokens, and
  hidden/history output-brief action rendering.
