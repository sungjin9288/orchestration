...
`growth-lifecycle-close-review-acceptance-status-recheck-smoke-readability-post-m7-2453`.
...
lifecycle-close-review-acceptance-status script, focused smoke, runtime behavior, UI behavior,
